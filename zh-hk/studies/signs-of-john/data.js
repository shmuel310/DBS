...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "發現耶穌是誰",
    "titleHtml": "約翰福音的神蹟",
    "lead": "約翰福音記載的八個神蹟標記，每一個都指向耶穌真實的身份：祂是生命的源頭、世上的光、神的兒子。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "確信與生命",
    "body": "八個神蹟記號，指向一個終極焦點：耶穌是基督，是神的兒子，叫一切信祂的得著生命。",
    "leadSomeoneElse": "你已經掌握了帶領這個課程的方式，隨時可以邀請下一位朋友開始。",
    "nextStudy": "《他是誰？》或《克服恐懼》都係極佳嘅後續課程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "summary": "迦拿婚宴中酒用盡了，耶穌將六口石缸的水變為上好美酒。這是祂行的頭一件神蹟，顯出祂的榮耀來，門徒就信了祂。",
      "lookBack": {
        "note": "仲未有「上次聚會」，所以今次先從呢度開始。",
        "questions": [
          "你叫咩名？同埋有冇一件事係小組大家可能仲未知道嘅？",
          "關於「耶穌係邊個」，有邊一點係你已經相信、或者感到好奇想探討嘅？",
          "你期望喺呢八次聚會中一齊有咩收穫？",
          "當我哋開始呢個課程之際，我哋可以點樣為你禱告？"
        ]
      },
      "lookUpPrayer": "從來未試過出聲禱告？一句起、兩句止就已經好足夠。為頭先交流中提到嘅一件事感謝上帝，然後求聖靈幫助你哋喺讀經時清晰明白這個神蹟。",
      ...
      "memoryVerse": {
        "ref": "約翰福音 2:11",
        "text": "這是耶穌所行的頭一件神蹟，是在加利利的迦拿行的，顯出他的榮耀來；他的門徒就信他了。"
      }
    },
    {
      "id": "2",
      ...
      "summary": "迦百農一位大臣因兒子病重前來求耶穌。耶穌一句話：「回去吧，你的兒子活了！」大臣相信這話回去，全家都信了主。",
    ...
    },
    {
      ...
      "summary": "在耶路撒冷畢士大池旁，耶穌主動醫治了一位病了三十八年的癱子，吩咐他拿起褥子行走，顯明掌管生命與安息日的權柄。",
      ...
      "memoryVerse": {
        "ref": "約翰福音 5:8–9",
        "text": "耶穌對他說：「起來，拿你的褥子走吧！」那人立刻痊癒，就拿起褥子來走了。"
      }
    },
    {
      "id": "4",
      ...
      "summary": "五餅二魚在耶穌手中祝謝擘開，餵飽了五千人並裝滿了十二個籃子。耶穌啟示自己就是從天上降下來生命的糧。",
      ...
      "memoryVerse": {
        "ref": "約翰福音 6:35",
        "text": "耶穌說：「我就是生命的糧。到我這裡來的，必定不餓；信我的，永遠不渴。」"
      }
    },
    {
      "id": "5",
      ...
      "summary": "門徒在黑夜狂風大浪中搖櫓苦難，耶穌在海面上向他們走來，說：「是我，不要怕！」立時平靜了眾人的懼怕。",
    ...
    },
    {
      ...
      "summary": "耶穌用唾沫和泥抹在生來盲眼之人的眼上，叫他往西羅亞池去洗。那人洗後回來看見了，見證耶穌是世界的光。",
    ...
    },
    {
      ...
      "summary": "拉撒路死了四天，耶穌在墳墓前宣告：「復活在我，生命也在我！」祂大聲呼叫拉撒路出來，死人就出來了。",
      ...
      "memoryVerse": {
        "ref": "約翰福音 11:25–26",
        "text": "耶穌對她說：「復活在我，生命也在我。信我的人雖然死了，也必復活；凡活著信我的人必永遠不死。你信這話嗎？」"
      }
    },
    {
      "id": "8",
      ...
      "summary": "空墳墓與向門徒的顯現。多馬親見復活的基督而敬拜：「我的主！我的神！」但記這些事要叫人信耶穌是基督，是神的兒子。",
