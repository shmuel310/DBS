...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "與天父親密的對話",
    "titleHtml": "教導我們禱告",
    "lead": "深入十段關於祈禱的聖經經文。從主禱文到客西馬尼園的呼求，學習坦然無懼來到恩典的寶座前，與神建立活潑深邃的禱告生命。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "不住的禱告",
    "body": "十課禱告之旅，引導我們敞開心扉與天父相交。祂必垂聽呼求，賜下隨時的恩惠。",
    "leadSomeoneElse": "你已經掌握了帶領這個課程的方式，隨時可以邀請下一位朋友開始。",
    "nextStudy": "《天國的奧祕》或《登山寶訓》都係極佳嘅後續課程。"
  },
  "sessions": [
    {
      "id": "1",
    ...
    },
    {
      ...
      "summary": "耶穌設不義之官與窮寡婦的比喻，教導人應當常常禱告，不可灰心。神豈不更要給祂晝夜呼籲的選民伸冤嗎？",
    ...
    },
    {
      ...
      "summary": "彼得被收在監裡，教會為他切切地禱告神。天使夜間拍醒彼得，鐵門自動打開，神施行拯救脫離希律的手。",
    ...
    },
    {
      ...
      "summary": "應當一無掛慮，凡事藉著禱告、祈求和感謝將所要的告訴神。神出人意外的平安必保守心懷意念。",
    ...
    },
    {
      ...
      "summary": "保羅在父面前屈膝，求神藉著聖靈使信徒心裡的力量剛強起來，使基督因信住在心裡，明白基督的愛何等長闊高深。",
      ...
      "memoryVerse": {
        "ref": "以弗所書 3:20–21",
        "text": "神能照著運行在我們心裡的大力充充足足地成就一切，超過我們所求所想的。但願他在教會中，並在基督耶穌裡，得著榮耀，直到世世代代，永永遠遠。阿們！"
      }
    },
    {
      "id": "6",
      ...
      "summary": "耶穌在客西馬尼園極其憂傷禱告：『我父啊，倘若可行，求你叫這杯離開我。然而，不要照我的意思，只要照你的意思。』",
      "lookUpPrayer": "Pray about what came up in Look Back, then ask the Holy Spirit to help you understand what you&rsquo;re about to read.",
    ...
    },
    {
      ...
      "summary": "我們的軟弱有聖靈幫助。我們本不曉得當怎樣禱告，只是聖靈親自用說不出來的歎息替我們祈求，鑒察人心的神曉得聖靈的意思。",
      "lookUpPrayer": "Bring what you just shared to God, then ask the Holy Spirit to reveal something in this passage you might otherwise miss.",
      ...
      "memoryVerse": {
        "ref": "羅馬書 8:26",
        "text": "況且，我們的軟弱有聖靈幫助；我們本不曉得當怎樣禱告，只是聖靈親自用說不出來的歎息替我們祈求。"
      }
    },
    {
      "id": "8",
      ...
      "summary": "門徒遭恐嚇後聚在一處禱告，求主賜大膽量講論真道並醫治顯神蹟。禱告完了，聚會的地方震動，眾人被聖靈充滿放膽講道。",
      "lookUpPrayer": "Pray for each other about whatever came up in Look Back, then invite the Holy Spirit to open your eyes as you read.",
    ...
    },
    {
      ...
      "summary": "哈拿因不能生育心裡愁苦，在耶和華面前痛痛哭泣祈禱，傾心吐意。以利給予祝福，神眷顧哈拿生下撒母耳。",
      "lookUpPrayer": "Pray about what&rsquo;s come up so far, then ask the Holy Spirit to help you see this passage clearly.",
      ...
      "memoryVerse": {
        "ref": "撒母耳記上 1:27",
        "text": "「我祈求為要得這孩子；耶和華已將我向他所求的賜給我了。」"
      }
    },
    {
      "id": "10",
      ...
      "summary": "你們要恆切禱告，在此警醒感恩；也要為傳道人祈求，求神給我們開傳道的門，能以宣揚基督的奧祕。",
