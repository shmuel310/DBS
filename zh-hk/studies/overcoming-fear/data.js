...
window.STUDY = {
  ...
  "lookForwardTemplate": "在（具體時間）之前，我會（行動），好讓（結果／應用）。",
  "welcomeCopy": {
    "tagline": "在風浪中得安息",
    "titleHtml": "克服恐懼",
    "lead": "十二次跨越新舊約的探索，從紅海之濱到啟示錄終局，發現神如何在我們最深沉的懼怕中賜下得勝的平安與勇氣。"
  },
  "methodCopy": {
    "lead": "每課查經都遵循相同嘅 <strong style=\"color:var(--ink-900);font-weight:600;\">3 個步驟</strong>，次序始終如一，無論係兩個人定係小組都適用。預計每次歷時約 <strong style=\"color:var(--ink-900);font-weight:600;\">60–90 分鐘</strong>。",
  ...
  "finishCopy": {
    "heading": "得勝有餘",
    "body": "十二段經文，見證了神在一切恐懼中的同在與信實。愛裡沒有懼怕，因為祂已經勝過了世界。",
    "leadSomeoneElse": "你已經掌握了帶領這個課程的方式，隨時可以邀請下一位朋友開始。",
    "nextStudy": "《新生命與真喜樂》（腓立比書）或《教導我們禱告》都係極佳嘅後續課程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "memoryVerse": {
        "ref": "出埃及記 14:13",
        "text": "摩西對百姓說：「不要懼怕，只管站住！看耶和華今天向你們所要施行的救恩。」"
      }
    },
    {
      "id": "2",
      ...
      "summary": "非利士巨人歌利亞辱罵永生神的軍隊，全軍驚惶害怕。牧羊少年大衛靠著萬軍之耶和華的名迎戰，甩石擊倒巨人，宣告爭戰的勝敗全在乎耶和華。",
      ...
      "memoryVerse": {
        "ref": "撒母耳記上 17:45",
        "text": "大衛對非利士人說：「你來攻擊我，是靠著刀槍和銅戟；我來攻擊你，是靠著萬軍之耶和華的名。」"
      }
    },
    {
      "id": "3",
      ...
      "summary": "大衛在詩歌中宣告耶和華是我的牧者，我必不致缺乏。縱使行過死蔭的幽谷也不怕遭害，因為神與我同在，祂的杖、祂的竿都安慰我。",
    ...
    },
    {
      ...
      "summary": "住在至高者隱密處的，必住在全能者的蔭下。詩篇91篇描繪神如何成為我們的避難所與山寨，吩咐使者在我們一切行徑上保護我們。",
      ...
      "memoryVerse": {
        "ref": "詩篇 91:10–11",
        "text": "禍患必不臨到你，災害也不挨近你的帳棚。因他要為你吩咐他的使者，在你行的一切道路上保護你。"
      }
    },
    {
      "id": "5",
      ...
      "summary": "耶穌教導門徒不要為生命憂慮吃甚麼喝甚麼，天上的飛鳥與野地的百合花神尚且看顧。你們要先求祂的國和祂的義，這一切都要加給你們了。",
    ...
    },
    {
      ...
      "summary": "加利利海上暴風巨浪襲來，船將滿了水，耶穌在船尾睡覺。門徒驚恐叫醒祂，耶穌斥責風浪立時大大平靜，並問門徒：「為甚麼膽怯？你們還沒有信心嗎？」",
      ...
      "memoryVerse": {
        "ref": "馬可福音 4:39–40",
        "text": "耶穌醒了，斥責風，向海說：「住了吧！靜了吧！」風就止住，大大地平靜了。耶穌對他們說：「為甚麼膽怯？你們還沒有信心嗎？」"
      }
    },
    {
      "id": "7",
      ...
      "summary": "門徒在夜間逆風搖櫓苦不堪言，耶穌在海面上向他們走來。門徒驚呼是鬼怪，耶穌連忙對他們說：「放心！是我，不要怕！」祂一上船風就住了。",
    ...
    },
    {
      ...
      "summary": "門徒因懼怕猶太人，聚會的地方門都關了。復活的耶穌親自站在當中，對他們說：「願你們平安！」並向他們吹氣受聖靈，恐懼頓時化為敬拜與差遣。",
      ...
      "memoryVerse": {
        "ref": "約翰福音 20:19",
        "text": "那日（就是七日的第一日）晚上，門徒所在的地方，因怕猶太人，門都關了。耶穌來，站在當中，對他們說：「願你們平安！」"
      }
    },
    {
      "id": "9",
      ...
      "summary": "保羅宣告：誰能使我們與基督的愛隔絕呢？無論是患難、困苦、危險、刀劍，靠著愛我們的主，在這一切的事上已經得勝有餘了。",
      ...
      "memoryVerse": {
        "ref": "羅馬書 8:38–39",
        "text": "因為我深信無論是死，是生，是天使，是掌權的，是有能的，是現在的事，是將來的事，是高處的，是低處的，是別的受造之物，都不能叫我們與神的愛隔絕；這愛是在我們的主基督耶穌裡的。"
      }
    },
    {
      "id": "10",
      ...
      "summary": "應當一無掛慮，只要凡事藉著禱告、祈求和感謝，將你們所要的告訴神。神那出人意外的平安，必在基督耶穌裡保守你們的心懷意念。",
      ...
      "memoryVerse": {
        "ref": "腓立比書 4:6–7",
        "text": "應當一無掛慮，只要凡事藉著禱告、祈求，和感謝，將你們所要的告訴神。神所賜、出人意外的平安必在基督耶穌裡保守你們的心懷意念。"
      }
    },
    {
      "id": "11",
      ...
      "summary": "信就是所望之事的實底，是未見之事的確據。古人在這信上得了美好的證據。人非有信就不能得神的喜悅，信靠神能越過眼前的危難。",
    ...
    },
    {
      ...
      "summary": "啟示錄展望永恆的新天新地：不再有死亡、悲哀、哭號、疼痛，也不再有咒詛。城中有神和羔羊的寶座，神要擦去一切眼淚，恐懼徹底永遠終結。",
      ...
      "memoryVerse": {
        "ref": "啟示錄 22:3",
        "text": "以後再沒有咒詛；在城裡有神和羔羊的寶座；他的僕人都要事奉他。"
      }
    }
  ]
};
