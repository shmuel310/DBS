...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "患難中的安息與盼望",
    "titleHtml": "10個安慰的應許",
    "lead": "十個給予心靈力量的聖經應許。無論面對焦慮、孤單、軟弱抑或失去，神信實的話語都是我們最堅固的避難所與隨時的幫助。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "滿有安慰",
    "body": "十個應許，承載著神永不改變的慈愛與信實。祂的平安超越世人的一切理解。",
    "leadSomeoneElse": "你已經掌握了帶領這個課程的方式，隨時可以邀請下一位朋友開始。",
    "nextStudy": "《教導我們禱告》或《天國的奧祕》都係極佳嘅後續課程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "summary": "保羅和西拉被毒打下在監牢內院，兩腳上了木狗。約在半夜，他們禱告唱詩讚美神，地大震動監門全開，禁卒全家信主得救。",
      "lookBack": {
        "note": "仲未有「上次聚會」，所以今次先從呢度開始。",
        "questions": [
          "你叫咩名？同埋有冇一件事係小組大家可能仲未知道嘅？",
          "有冇邊個人俾你嘅承諾，係至今仍然堅定不移、切實守住嘅？",
          "你期望喺呢十次聚會中一齊有咩收穫？",
      ...
      "memoryVerse": {
        "ref": "約翰福音 14:27",
        "text": "「我留下平安給你們；我將我的平安賜給你們。我所賜的，不像世人所賜的。你們心裡不要憂愁，也不要膽怯。」"
      }
    },
    {
      "id": "2",
      ...
      "summary": "大衛深知耶和華已經鑒察我、認識我。我往哪裡去躲避你的靈？神在母腹中覆庇我，我的受造奇妙可畏，神深切看顧每一刻。",
    ...
    },
    {
      ...
      "summary": "五餅二魚餵飽五千人。在門徒看為絕不可能之處，耶穌行出神蹟，顯明神恩典的供應遠超我們所求所想，甚至裝滿十二個籃子。",
      ...
      "memoryVerse": {
        "ref": "腓立比書 4:19",
        "text": "我的神必照他榮耀的豐富，在基督耶穌裡，使你們一切所需用的都充足。"
      }
    },
    {
      "id": "4",
      ...
      "summary": "遮掩過犯的必不亨通，承認離棄罪過的必蒙憐恤。當大衛閉口不認罪時骨頭枯乾，向神陳明罪愆後得蒙赦免，得著救恩的樂歌。",
    ...
    },
    {
      ...
      "summary": "兩個心灰意冷的門徒往以馬忤斯去，復活的耶穌親自就近同行，沿途講解聖經。直到擘餅時他們眼睛明亮認出祂來，心裡火熱。",
    ...
    },
    {
      ...
      "summary": "你們中間有受苦的呢，他就該禱告；有喜樂的呢，他就該歌頌。出於信心的祈禱要救那病人，義人祈禱所發的力量是大有功效的。",
      "lookUpPrayer": "Pray about what came up in Look Back, then ask the Holy Spirit to help you understand what you&rsquo;re about to read.",
    ...
    },
    {
      ...
      "summary": "你們心裡不要憂愁；你們信神，也當信我。在我父的家裡有許多住處，我去原是為你們預備地方去，必再來接你們到我那裡去。",
      "lookUpPrayer": "Bring what you just shared to God, then ask the Holy Spirit to reveal something in this passage you might otherwise miss.",
    ...
    },
    {
      ...
      "summary": "保羅肉體上有一根刺，三次求主叫這刺離開。主對他說：『我的恩典夠你用的，因為我的能力是在人的軟弱上顯得完全。』",
      "lookUpPrayer": "Pray for each other about whatever came up in Look Back, then invite the Holy Spirit to open your eyes as you read.",
    ...
    },
    {
      ...
      "summary": "大衛夜觀星空讚歎：人算甚麼，你竟顧念他！世人算甚麼，你竟眷顧他！神賜人榮耀尊貴為冠冕，派人管理祂手所造的萬物。",
    ...
    },
    {
      ...
      "summary": "我們既因信稱義，就藉著主耶穌基督得與神相和。不但如此，就是在患難中也是歡歡喜喜的，因為知道患難生忍耐，盼望不至於羞恥。",
      "lookUpPrayer": "Pray about everything this course has stirred up in you, then ask the Holy Spirit to help you see where he&rsquo;s been quietly at work in your own story too.",
      ...
      "memoryVerse": {
        "ref": "約翰福音 16:24",
        "text": "「向來你們沒有求過甚麼，如今你們求，就必得著，叫你們的喜樂可以滿足。」"
      }
    }
  ]
};
