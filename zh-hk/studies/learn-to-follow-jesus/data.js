...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "門徒成長的八個關鍵",
    "titleHtml": "學習跟隨耶穌",
    "lead": "為初信者和渴望扎根的門徒而設。八次聚會涵蓋門訓、洗禮、禱告、與主連結、愛神愛人、堅忍、聖餐及合一。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "扎根成長",
    "body": "八個根基，指引我們如何一生跟隨耶穌，作忠心傳承的門徒。",
    "leadSomeoneElse": "你已經掌握了帶領這個課程的方式，隨時可以邀請下一位朋友開始。",
    "nextStudy": "《耶穌的吩咐》或《接觸、得著、建立、培訓、差遣》都係極佳嘅後續課程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "summary": "若有人在基督裡就是新造的人。神將使人和好的職分賜給我們，聖靈降臨賜下能力，差遣我們直到地極作主的見證。",
      "lookBack": {
    ...
    },
    {
      ...
      "summary": "腓利順服聖靈帶領向埃提阿伯太監傳講耶穌，太監信而受洗。耶穌吩咐使萬民作門徒，奉父子聖靈的名給他們施洗。",
      ...
      "memoryVerse": {
        "ref": "馬太福音 28:19",
        "text": "「所以，你們要去，使萬民作我的門徒，奉父、子、聖靈的名給他們施洗。」"
      }
    },
    {
      "id": "3",
      ...
      "summary": "門徒求耶穌教導禱告，耶穌傳授主禱文，並應許祈求就得著、尋找就尋見、叩門就給你們開門，天父必將聖靈賜給求祂的人。",
    ...
    },
    {
      ...
      "summary": "耶穌是真葡萄樹，我們是枝子。常在祂裡面的，祂也常在我們裡面，這人就多結果子；因為離了祂，我們就不能做甚麼。",
      ...
      "memoryVerse": {
        "ref": "約翰福音 15:5",
        "text": "「我是葡萄樹，你們是枝子。常在我裡面的，我也常在他裡面，這人就多結果子；因為離了我，你們就不能做甚麼。」"
      }
    },
    {
      "id": "5",
      ...
      "summary": "好撒瑪利亞人的比喻：打破隔閡去憐憫受傷的人。相愛不要只在言語和舌頭上，總要在行為和誠實上。",
    ...
    },
    {
      ...
      "summary": "使徒受公會審訊鞭打，反倒歡喜，因被算是配為這名受辱。為主的名受苦不是可恥的事，倒要歸榮耀給神。",
    ...
    },
    {
      ...
      "summary": "主設立聖餐：這是我為你們捨的身體，這杯是用我的血所立的新約。信徒恆心遵守使徒的教訓，擘餅、祈禱、彼此交接。",
    ...
    },
    {
      ...
      "summary": "初代教會信徒天天同心合意，存著歡喜誠實的心用飯，讚美神，得眾民的喜愛。耶穌祈求所有信祂的人合而為一，叫世人信祂。",
      ...
      "memoryVerse": {
        "ref": "約翰福音 17:21",
        "text": "「使他們合而為一。正如你父在我裡面，我在你裡面，使他們也在我們裡面，叫世人可以信你差了我來。」"
      }
    }
  ]
};
