...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "從永恆之約到榮耀再臨",
    "titleHtml": "神的國度",
    "lead": "十二個星期的聖經全景探索。從亞伯拉罕之約到啟示錄終極的得勝，發現神的國度如何在歷史中展開，並在基督耶穌裡完全成就。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "國度永存",
    "body": "十二課縱覽神國度的宏偉藍圖。我們已遷入愛子的國度，帶著君尊祭司的榮耀身份活在世上。",
    "leadSomeoneElse": "你已經掌握了帶領這個課程的方式，隨時可以邀請下一位朋友開始。",
    "nextStudy": "《登山寶訓》或《他是誰？》都係極佳嘅後續課程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "summary": "耶和華向九十九歲的亞伯蘭顯現立約，改其名為亞伯拉罕，應許他作多國之父，國度從他而立，君王從他而出，神要做他和他後裔的神。",
      "lookBack": {
    ...
    },
    {
      ...
      "summary": "摩西在西奈山聽見神的宣告：全地都是屬我的，你們若聽從我的話遵守我的約，就要在萬民中作屬我的子民，成為祭司的國度與聖潔的國民。",
      ...
      "memoryVerse": {
        "ref": "出埃及記 19:5–6",
        "text": "「如今你們若實在聽從我的話，遵守我的約，就要在萬民中作屬我的子民，因為全地都是我的。你們要歸我作祭司的國度，為聖潔的國民。」"
      }
    },
    {
      "id": "3",
      ...
      "summary": "但以理為尼布甲尼撒王解大像之夢：金銀銅鐵泥的各國終必過去，有一塊非人手鑿出的石頭打碎大像變成大山充滿天下，神必另立一永不敗壞的國度。",
    ...
    },
    {
      ...
      "summary": "在黑暗中行走的百姓看見了大光。先知預言有一嬰孩為我們而生，政權必擔在祂的肩頭上，祂的國度必以公平公義堅定直到永遠。",
      ...
      "memoryVerse": {
        "ref": "以賽亞書 9:6",
        "text": "因有一嬰孩為我們而生；有一子賜給我們。政權必擔在他的肩頭上；他名稱為「奇妙策士、全能的神、永在的父、和平的君」。"
      }
    },
    {
      "id": "5",
      ...
      "summary": "約翰下監後，耶穌來到加利利宣傳神的福音：日期滿了，神的國近了！你們當悔改，信福音。這正是國度君王的降臨宣召。",
    ...
    },
    {
      ...
      "summary": "天國好像人撒好種在田裡，仇敵來撒了稗子。收割之前容兩樣一齊長，世界的末了天使要薅出稗子用火焚燒，義人在父的國裡要發出光來。",
      ...
      "memoryVerse": {
        "ref": "馬太福音 13:43",
        "text": "「那時，義人在他們父的國裡，要發出光來，像太陽一樣。有耳可聽的，就應當聽！」"
      }
    },
    {
      "id": "7",
      ...
      "summary": "天國好像藏在田裡的寶貝，又像貴重珍珠，人歡歡喜喜變賣一切所有的去買它；天國又如撒網聚攏各樣水族，好的收在器具裡，不好的丟棄。",
      ...
      "memoryVerse": {
        "ref": "馬太福音 13:44",
        "text": "「天國好像寶貝藏在地裡，人遇見了就把它藏起來，歡歡喜喜地去變賣一切所有的，買這塊地。」"
      }
    },
    {
      "id": "8",
      ...
      "summary": "彼得認信耶穌是基督、是永生神的兒子。耶穌宣告要把教會建造在這磐石上，陰間的權柄不能勝過它，並賜下天國的鑰匙。",
    ...
    },
    {
      ...
      "summary": "彼拉多審問耶穌是否為猶太人的王。耶穌回答：『我的國不屬這世界；我的國若屬這世界，我的臣僕必要爭戰。我為此而生，也為此來到世間。』",
      ...
      "memoryVerse": {
        "ref": "約翰福音 18:36",
        "text": "耶穌回答說：「我的國不屬這世界；我的國若屬這世界，我的臣僕必要爭戰，使我不至於被交給猶太人。只是我的國不屬這世界。」"
      }
    },
    {
      "id": "10",
      ...
      "summary": "耶穌受難復活後四十天向門徒講論神國的事。祂吩咐門徒不要離開耶路撒冷，等候聖靈降臨得著能力，在全地作祂的見證直等到祂再來。",
      "lookUpPrayer": "Try praying a full sentence or two this week: name what came up in Look Back, then ask the Holy Spirit to reveal something as you read.",
    ...
    },
    {
      ...
      "summary": "父神救了我們脫離黑暗的權勢，把我們遷到祂愛子的國裡；我們在愛子裡得蒙救贖，罪過得以赦免。祂是教會的全體之首。",
      "lookUpPrayer": "Pray honestly about what surfaced in Look Back, even the hard parts, then ask the Holy Spirit to help this passage land.",
      ...
      "memoryVerse": {
        "ref": "歌羅西書 1:13–14",
        "text": "他救了我們脫離黑暗的權勢，把我們遷到他愛子的國裡；我們在愛子裡得蒙救贖，罪過得以赦免。"
      }
    },
    {
      "id": "12",
      ...
      "summary": "第七位天使吹號，天上有大聲音說：世上的國成了我主和主基督的國；祂要作王，直到永永遠遠！二十四位長老面伏於地敬拜讚美全能者。",
