...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "恩典與救贖的旅程",
    "titleHtml": "路得記",
    "lead": "一個關於喪失、忠誠與救贖的動人故事。五次研讀走過士師時代這段美麗的歷史，見證神的恩惠如何默默引導人的腳步。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "救贖的恩典",
    "body": "五課走過路得記，看見神在平凡的日子裡編織偉大的救贖。祂從不撇棄投靠祂翅膀底下的人。",
    "leadSomeoneElse": "你已經掌握了帶領這個課程的方式，隨時可以邀請下一位朋友開始。",
    "nextStudy": "《學習跟隨耶穌》或《耶穌的吩咐》都係極佳嘅後續課程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "summary": "拿俄米在摩押地痛失丈夫與二子，決定返回伯利恆。兒婦路得定意跟隨，誓言：「你的國就是我的國，你的神就是我的神。」滿滿出去、空空回來的拿俄米在動盪中重踏故土。",
      "lookBack": {
      ...
      "memoryVerse": {
        "ref": "路得記 1:16",
        "text": "路得說：「不要催我回去不跟隨你。你往哪裡去，我也往哪裡去；你在哪裡住宿，我也在哪裡住宿；你的國就是我的國，你的神就是我的神。」"
      }
    },
    {
      "id": "2",
      ...
      "summary": "路得為奉養婆婆，恰巧來到親族波阿斯的田間拾麥穗。波阿斯厚待外邦女子路得，稱讚她孝敬婆婆並投靠耶和華翅膀底下的忠信。",
      ...
      "memoryVerse": {
        "ref": "路得記 2:12",
        "text": "「願耶和華照你所行的賞賜你。你來投靠耶和華——以色列神的翅膀下，願你滿得他的賞賜。」"
      }
    },
    {
      "id": "3",
      ...
      "summary": "拿俄米為路得尋求安身之處，指導路得夜間前往麥場。波阿斯驚醒，答應承擔至親救贖者的責任，稱讚路得是個賢德的女子。",
      ...
      "memoryVerse": {
        "ref": "路得記 3:9",
        "text": "他就說：「你是誰？」回答說：「我是你的婢女路得。求你用你的衣襟遮蓋我，因為你是我一個至近的親屬。」"
      }
    },
    {
      "id": "4",
      ...
      "summary": "波阿斯在城門口長老面前，公開詢問更近的親屬；那人放棄贖產權利後，波阿斯正式贖買以利米勒的產業，並迎娶路得為妻。",
      ...
      "memoryVerse": {
        "ref": "路得記 4:10",
        "text": "「我又娶了瑪倫的妻摩押女子路得為妻，好在死人的產業上存留他的名，免得他的名在弟兄中、在本鄉滅沒。你們今日可以作見證。」"
      }
    },
    {
      "id": "5",
      ...
      "summary": "耶和華使路得懷孕生子俄備得。婦人們向拿俄米祝賀神不絕恩惠，俄備得後來生耶西，耶西生大衛王。神的美意成全了救贖世系。",
      ...
      "memoryVerse": {
        "ref": "路得記 4:14–15",
        "text": "婦人們對拿俄米說：「耶和華是應當稱頌的！因為今日沒有撇下你，使你沒有至近的親屬。願這孩子在以色列中得名聲。他必提起你的精神，奉養你的老，因為是愛慕你的那兒婦所生的。有這兒婦比有七個兒子還好！」"
      }
    }
  ]
};
