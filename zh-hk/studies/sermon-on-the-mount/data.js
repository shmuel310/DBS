...
window.STUDY = {
  ...
  "sessionsLabel": "八個星期",
  "welcomeCopy": {
    "tagline": "馬太福音 5–7 章的天國憲章",
    "titleHtml": "登山寶訓",
    "lead": "耶穌在山上所傳授最深刻著名的天國憲章。八個星期細讀八福、光與鹽、更深的公義、隱密處的敬虔，以及建立在磐石上的生命。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "建立在磐石上",
    "body": "八週登山寶訓，塑造我們成為聽道且行道的人。將生命建造在基督的磐石上，永不動搖。",
    "leadSomeoneElse": "你已經掌握了帶領這個課程的方式，隨時可以邀請下一位朋友開始。",
    "nextStudy": "《他是誰？》或《接觸、得著、建立、培訓、差遣》都係極佳嘅後續課程。"
  },
  "sessions": [
    {
      "id": "1",
    ...
    },
    {
      ...
      "summary": "你們是世上的鹽、世上的光。光當照在人前，榮耀歸給天父。耶穌來不是要廢掉律法和先知，乃是要成全。",
    ...
    },
    {
      ...
      "summary": "從向弟兄動怒、眼目淫念，到起誓、愛仇敵。耶穌剖開律法的字句直指內心深處的動機：你們要完全，像你們的天父完全一樣。",
    ...
    },
    {
      ...
      "summary": "不可將善事行在人前故意叫人看見。無論施捨、禱告或禁食，都要行在暗中，你父在暗中察看，必然報答你。耶穌親授主禱文。",
      ...
      "memoryVerse": {
        "ref": "馬太福音 6:9–10",
        "text": "「所以，你們禱告要這樣說：『我們在天上的父：願人都尊你的名為聖。願你的國降臨；願你的旨意行在地上，如同行在天上。』」"
      }
    },
    {
      "id": "5",
      ...
      "summary": "不要為自己積攢財寶在地上，只要積攢在天上；你的財寶在哪裡，你的心也在哪裡。不要為明天憂慮，先求神的國和祂的義。",
    ...
    },
    {
      ...
      "summary": "你們不要論斷人免得被論斷。先去掉自己眼中的樑木。祈求就得著，叩門就開門。無論何事，你們願意人怎樣待你們，你們也要怎樣待人。",
    ...
    },
    {
      ...
      "summary": "你們要進窄門。引到滅亡的門是寬的路是大的，進去的人也多；引到永生，門是窄的路是小的，找著的人也少。防備假先知，看果子認樹。",
      ...
      "memoryVerse": {
        "ref": "馬太福音 7:14",
        "text": "「引到滅亡，那門是寬的，路是大的，進去的人也多；引到永生，那門是窄的，路是小的，找著的人也少。」"
      }
    },
    {
      "id": "8",
      ...
      "summary": "凡聽見耶穌這話就去行的，好比一個聰明人把房子蓋在磐石上；風吹雨淋總不倒塌。眾人都希奇祂的教訓，因為祂教導像有權柄的人。",
