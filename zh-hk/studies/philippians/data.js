...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "腓立比書探索之旅",
    "titleHtml": "新生命與真喜樂",
    "lead": "保羅在獄中所寫下滿溢喜樂的書信。六個星期走進腓立比書，發現超越環境的平安、在基督裡的合一與真正的生命喜樂。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "真正的喜樂",
    "body": "六週細讀腓立比書，我們發現喜樂不是來自無憂無慮的環境，而是深植於基督耶穌裡的平安與信靠。",
    "leadSomeoneElse": "你已經掌握了帶領這個課程的方式，隨時可以邀請下一位朋友開始。",
    "nextStudy": "《路得記》或《學習跟隨耶穌》都係極佳嘅後續課程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "summary": "保羅在捆鎖中為腓立比信徒歡歡喜喜地祈求，深信那在他們心裡動了善工的，必成全這工，直到耶穌基督的日子。",
      "lookBack": {
    ...
    },
    {
      ...
      "summary": "保羅表明自己的遭遇反而叫福音興旺。無論生死，總叫基督在他身上照常顯大；因他活著就是基督，死了就有益處。",
    ...
    },
    {
      ...
      "summary": "基督耶穌本有神的形像，卻虛己取了奴僕的形像，存心順服以至於死，且死在十字架上。神將祂升為至高，萬膝必向祂跪拜。",
      ...
      "memoryVerse": {
        "ref": "腓立比書 2:9–11",
        "text": "所以，神將他升為至高，又賜給他那超乎萬名之上的名，叫一切在天上的、地上的，和地底下的，因耶穌的名無不屈膝，無不口稱「耶穌基督為主」，使榮耀歸與父神。"
      }
    },
    {
      "id": "4",
      ...
      "summary": "當恐懼戰兢做成得救的工夫，因為是神在心裡運行。保羅稱讚提摩太和以巴弗提，他們顧念基督的事，甚至不顧性命。",
      ...
      "memoryVerse": {
        "ref": "腓立比書 2:13",
        "text": "因為你們立志行事都是神在你們心裡運行，為要成全他的美意。"
      }
    },
    {
      "id": "5",
      ...
      "summary": "保羅將昔日引以為傲的宗教履歷都看作糞土，為要得著基督，並曉得祂復活的大能，忘記背後努力面前向著標竿直跑。",
      ...
      "memoryVerse": {
        "ref": "腓立比書 3:9",
        "text": "並且得以在他裡面，不是有自己因律法而得的義，乃是有信基督的義，就是因信神而來的義。"
      }
    },
    {
      "id": "6",
      ...
      "summary": "應當一無掛慮，凡事藉禱告交託神，神出人意外的平安必保守心懷意念。保羅學會了處卑賤與富足的祕訣：靠著愛他的主凡事都能做。",
