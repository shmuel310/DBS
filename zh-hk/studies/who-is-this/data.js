...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "馬可福音探索之旅",
    "titleHtml": "他<br>是<br>誰？",
    "lead": "十個星期走進馬可福音。每週細讀一段經文，一同發現耶穌是誰，並肩同行跟隨祂——適合小組查經或一對一門訓。"
  },
  "methodCopy": {
    "lead": "每週查經都遵循相同嘅 <strong style=\"color:var(--ink-900);font-weight:600;\">3 個步驟</strong>，次序始終如一，無論係兩個人定係小組都適用。預計每次歷時約 <strong style=\"color:var(--ink-900);font-weight:600;\">60–90 分鐘</strong>，時間僅供參考。",
    "lookBackBlurb": "打開聖經之前，先作一次簡短真誠嘅關顧回顧：上週過得點樣、有咩嘗試同實踐、可以點樣彼此代禱。",
    "lookUpBlurb": "先禱告，然後輪流出聲讀出經文，用自己嘅說話重述故事，確保大家都掌握整體情節。然後由五條核心問題引導深入發現。",
    "lookForwardBlurb": "將你所發現嘅轉化為生命嘅實際回應：一項行為改變、一個信靠嘅應許、一個效法嘅榜樣，或者一條順服嘅命令。決定今個星期向邊個分享這段經文，最後在結束前彼此代禱。該位對象將成為下週「回顧」嘅分享內容。",
    "betweenBlurb": "多數星期仲包括一段自選嘅個人研讀經文，涵蓋小組略過嘅馬可福音故事段落。無人會查問督促，純粹為想在下次聚會前掌握更完整圖景嘅人而設。"
  },
  "finishCopy": {
    "heading": "做得好！",
    "body": "十個星期，十段經文，一個貫穿始終嘅問題：他是誰？你哋一齊回顧、向上看、向前展望，走過咗成個旅程。這絕非微不足道嘅一步，更唔係真正嘅終點。",
    "leadSomeoneElse": "呢個課程設計到完全唔需要特別培訓，意味住你已經具備帶領其他人研讀嘅資格。你已經用咗十個星期同人分享每段經文，佢哋就係你最自然嘅第一批邀請對象。預備好嘅時候，重設你嘅進度，同佢哋重新開始啦。",
    "nextStudy": "喺不知不覺中，你已經掌握咗「發現式查經」（DBS）——一種簡單、可複製嘅讀經方式：回顧、向上看、向前展望。繼續喺你個人靈修或同其他人讀經時保持呢個節奏。《基礎入門》同《新生命與真喜樂》（腓立比書）都係極佳嘅後續課程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "summary": "耶穌受洗，在曠野受試探，並開始宣講神的國近了。祂呼召了第一批門徒——平凡的漁夫；他們立刻撇下一切，跟從了祂。",
    ...
    },
    {
      ...
      "summary": "四個朋友拆通房頂，將一個癱子縋到耶穌面前。耶穌在醫治他的雙腿之前先赦免了他的罪——這是惟有神才擁有的權柄。",
    ...
    },
    {
      ...
      "summary": "加利利海上突如其來的風暴，讓經驗豐富的漁夫們嚇得魂飛魄散。耶穌一句話平靜了風浪，門徒們不禁問出本課程得名的那個核心問題。",
    ...
    },
    {
      ...
      "summary": "一個走投無路的父親，和一個患病十二年的絕望婦人。兩個人都跨越重重障礙來到耶穌面前，發現祂的同情心遠超他們的想像。",
    ...
    },
    {
      ...
      "summary": "在偏僻荒野，五千人又累又餓。門徒想叫眾人散去，但耶穌拿著五個餅兩條魚祝謝，門徒親自分給眾人，所有人都吃飽了。",
    ...
    },
    {
      ...
      "summary": "在該撒利亞腓立比的路上，耶穌問門徒：你們說我是誰？彼得給出正確的答案，但耶穌緊接著預告自己的受難，並闡明跟從祂的真正代價。",
    ...
    },
    {
      ...
      "summary": "當耶穌走向耶路撒冷的十字架時，雅各和約翰卻在爭奪最高的位置。耶穌以自己的生命定義了真正的偉大：服事人，而非受人服事。",
    ...
    },
    {
      ...
      "summary": "一位文士問耶穌誡命中哪一條是第一要緊的。耶穌的回答將所有宗教規條精簡為兩個方向的愛：盡心愛神，愛人如己。",
    ...
    },
    {
      ...
      "summary": "最後晚餐中設立的餅與杯，隨後在客西馬尼園中 agonizing 的禱告。門徒睡著了，耶穌獨自順服父神的旨意。",
    ...
    },
    {
      ...
      "summary": "釘十字架、斷氣、安葬，隨後在清晨發現的空墳墓。馬可福音以驚歎、敬畏與一個尚未終結的故事結束。",
      ...
      "memoryVerse": {
        "ref": "馬可福音 16:6",
        "text": "那少年人對她們說：「不要驚恐！你們尋找那釘十字架的拿撒勒人耶穌，他已經復活了，不在這裡。請看安放他的地方。」"
      }
    }
  ],
  "bonusSessions": [
    {
      ...
      "bonus": true,
      "fitsAfter": "適合在第 2 週（誰能赦罪？）之後進行",
      "summary": "耶穌上山隨自己意思叫人來，設立了十二使徒，要他們常和自己同在，也差他們去傳道並賜權柄趕鬼。",
    ...
    },
    {
      ...
      "bonus": true,
      "fitsAfter": "適合在第 3 週（他是誰？）之後進行",
      "summary": "耶穌在海邊教導撒種的比喻：道撒在路旁、土淺石頭地、荊棘裡，以及結實百倍的好土上。",
    ...
    },
    {
      ...
      "bonus": true,
      "fitsAfter": "適合在第 3 週（他是誰？）之後進行",
      "summary": "格拉森被群鬼附身的人獲釋得救。耶穌吩咐他回家去，將主為他做何等大的事都告訴親友。",
      ...
      "memoryVerse": {
        "ref": "馬可福音 5:19",
        "text": "耶穌不許，卻對他說：「你回家去，到你的親屬那裡，將主為你所做的是何等大的事，是怎樣憐憫你，都告訴他們。」"
      }
    },
    {
      "id": "B4",
      ...
      "bonus": true,
      "fitsAfter": "適合在第 6 週（我是誰？）之後進行",
      "summary": "耶穌清楚說明跟從祂的要求：捨己，背起自己的十字架來跟從祂，人若賺得全世界賠上生命有何益處。",
    ...
    },
    {
      ...
      "bonus": true,
      "fitsAfter": "適合在第 6 週（我是誰？）之後進行",
      "summary": "登山變貌，耶穌在門徒面前顯出榮光，摩西、以利亞顯現，雲彩中有聲音說：這是我的愛子，你們要聽他。",
      ...
      "memoryVerse": {
        "ref": "馬可福音 9:7",
        "text": "有一朵雲彩來遮蓋他們；也有聲音從雲彩裡出來，說：「這是我的愛子，你們要聽他。」"
      }
    },
    {
      "id": "B6",
      ...
      "bonus": true,
      "fitsAfter": "適合在第 7 週（並非受人服事）之後進行",
      "summary": "討飯的瞎子巴底買呼求大衛的子孫。耶穌問他：你要我為你做甚麼？他立時看見，在路上跟隨耶穌。",
      ...
      "memoryVerse": {
        "ref": "馬可福音 10:52",
        "text": "耶穌說：「你去吧！你的信救了你了。」盲人立刻看見了，就在路上跟隨耶穌。"
      }
    },
    {
      "id": "B7",
      ...
      "bonus": true,
      "fitsAfter": "適合在第 7 週（並非受人服事）之後進行",
      "summary": "耶穌騎著驢駒進耶路撒冷，眾人喊和散那；隨後進殿趕出做買賣的人，宣明我的殿必稱為萬國禱告的殿。",
      ...
      "memoryVerse": {
        "ref": "馬可福音 11:9",
        "text": "前行後隨的人都喊著說：「和散那！奉主名來的是應當稱頌的！」"
      }
    },
    {
      "id": "B8",
      ...
      "bonus": true,
      "fitsAfter": "適合在第 9 週（晚餐與園子）之後進行",
      "summary": "大祭司審問耶穌，耶穌宣告自己是神子；外院的彼得卻在使女面前三次不敢承認主，隨後痛哭。",
