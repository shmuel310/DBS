...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "從創世記到福音書",
    "titleHtml": "基<br>礎<br>入<br>門",
    "lead": "十課縱覽聖經宏大故事：從創世、墮落，到十字架與復活。每次細讀一段經文，發現神貫穿始終的心意，並肩同行作出生命回應——適合小組或一對一門訓。"
  },
  "methodCopy": {
    "lead": "每課查經都遵循相同嘅 <strong style=\"color:var(--ink-900);font-weight:600;\">3 個步驟</strong>，次序始終如一，無論係兩個人定係小組都適用。預計每次歷時約 <strong style=\"color:var(--ink-900);font-weight:600;\">90 分鐘</strong>，若時間緊湊，60 分鐘亦完全可行。",
    "lookBackBlurb": "互相重新連結嘅時刻：這星期你點樣經歷神、有咩感恩、有咩難處，以及上次所學嘅在生活中如何實際落實。",
    "lookUpBlurb": "輪流出聲讀出經文，用自己嘅說話重述故事，確保大家都掌握整體情節。然後由幾個核心問題引導深入發現。",
    "lookForwardBlurb": "將你所發現嘅轉化為生命嘅實際回應：一項行為改變、一個信靠嘅應許、一個效法嘅榜樣，或者一條順服嘅命令。然後定立一個明確具體嘅行動目標（幾時之前、做啲咩、點解重要），決定今個星期向邊個分享這段經文，最後在結束前彼此代禱。",
    "respondItems": [
      "改變一項行為？",
      "信靠一個應許？",
      "效法一個榜樣？",
  ...
  "finishCopy": {
    "heading": "新生命",
    "body": "十課歷程，從伊甸園到空墳墓，一個關於神是誰、人如何走偏，以及神如何拯救嘅偉大故事。你們一齊回顧、向上看、向前展望，走過咗整個旅程。這絕非微不足道嘅一步，正如最後一課所言，這係生命全新嘅開端，而非終結。",
    "leadSomeoneElse": "呢個課程設計到完全唔需要特別培訓，意味住你已經具備帶領其他人研讀嘅資格。你在這些課堂中與人分享每段經文，佢哋就係你最自然嘅第一批邀請對象。預備好嘅時候，重設你嘅進度，同佢哋重新開始啦。",
    "nextStudy": "喺不知不覺中，你已經掌握咗「發現式查經」（DBS）——一種簡單、可複製嘅讀經方式：回顧、向上看、向前展望。繼續喺你個人靈修或同其他人讀經時保持呢個節奏。《他是誰？》（馬可福音）係極佳嘅後續課程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "summary": "神用塵土造了第一個人，吹入生命氣息，安置在伊甸園中修理看守，並造女人作為平等的伴侶。一切都甚好，二人赤身露體並不羞恥。",
      "lookBack": {
    ...
    },
    {
      ...
      "summary": "蛇誘騙夏娃與亞當懷疑神，吃了吩咐不可吃的分別善惡樹果子。羞恥、推卸責任，以及與神與彼此的隔絕隨即臨到。",
    ...
    },
    {
      ...
      "summary": "人類罪惡蔓延，神為造人而憂傷，決定用洪水審判大地。惟有挪亞蒙恩稱為義人，建造方舟保全全家與活物。",
    ...
    },
    {
      ...
      "summary": "神將以色列民從埃及為奴之地拯救出來後，在西奈山頒布十誡，奠定人與神、人與人同住的核心約定。",
    ...
    },
    {
      ...
      "summary": "掃羅王背離神後，神差撒母耳膏立少年大衛為以色列未來的王。神看人不看外貌，乃是看內心。",
      ...
      "memoryVerse": {
        "ref": "撒母耳記上 16:7",
        "text": "耶和華對撒母耳說：「不要看他的外貌和他身材高大，我不揀選他。因為耶和華不像人看人：人是看外貌；耶和華是看內心。」"
      }
    },
    {
      "id": "6",
      ...
      "summary": "先知以賽亞預言一位受苦的僕人，因我們的過犯受害，擔當我們的罪孽，神使我們眾人的罪孽都歸在祂身上。",
    ...
    },
    {
      ...
      "summary": "耶穌降生在伯利恆的馬槽中。天使向野地看守羊群的牧羊人報大喜信息：今天為你們生了救主，就是主基督。",
      ...
      "memoryVerse": {
        "ref": "路加福音 2:10–11",
        "text": "那天使對他們說：「不要懼怕！我報給你們大喜的信息，是關乎萬民的；因今天在大衛的城裡，為你們生了救主，就是主基督。」"
      }
    },
    {
      "id": "8",
      ...
      "summary": "耶穌路過耶利哥，主動走進稅吏長撒該的家。撒該生命徹底改變，耶穌宣明人子來是為尋找拯救失喪的人。",
    ...
    },
    {
      ...
      "summary": "耶穌被戲弄、鞭打，釘在羅馬十字架上。殿裡的幔子從上到下裂為兩半，百夫長見證：「這人真是神的兒子！」",
      ...
      "memoryVerse": {
        "ref": "馬可福音 15:39",
        "text": "對面站著的百夫長看見耶穌這樣氣絕，就說：「這人真是神的兒子！」"
      }
    },
    {
      "id": "10",
      ...
      "summary": "婦女清晨來到墳墓，看見石頭已經挪開，天使宣告基督已復活。耶穌向門徒顯現，頒布使萬民作門徒的大使命。",
      ...
      "memoryVerse": {
        "ref": "馬太福音 28:5–6",
        "text": "天使對婦女說：「不要害怕！我知道你們是尋找那釘十字架的耶穌。他不在這裡，照他所說的，已經復活了。你們來看安放主的地方。」"
      }
    }
  ]
};
