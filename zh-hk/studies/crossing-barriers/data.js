...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "基督裡的復和與接納",
    "titleHtml": "跨越隔閡",
    "lead": "探索十段聖經經文，見證福音如何跨越種族、社會階層、性別與道德的藩籬，在基督裡拆毀中間隔斷的牆，成就真正的和好。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "拆毀隔閡",
    "body": "十段經文，見證了基督十字架化解一切冤仇的大能。祂差遣我們作使人和好的使者。",
    "leadSomeoneElse": "你已經掌握了帶領這個課程的方式，隨時可以邀請下一位朋友開始。",
    "nextStudy": "《10個安慰的應許》或《教導我們禱告》都係極佳嘅後續課程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "memoryVerse": {
        "ref": "約翰福音 4:9",
        "text": "撒瑪利亞的婦人對他說：「你既是猶太人，怎麼向我一個撒瑪利亞婦人要水喝呢？」（原來猶太人和撒瑪利亞人沒有來往。）"
      }
    },
    {
      "id": "2",
      ...
      "summary": "神藉著基督使我們與祂和好，又將勸人與祂和好的職分賜給我們。在基督裡，我們不再按外貌認人。",
    ...
    },
    {
      ...
      "summary": "一個有罪的女人用眼淚濕了耶穌的腳並抹上香膏。耶穌宣告凡多得赦免的人愛也多，打破了自以為義的道德偏見。",
    ...
    },
    {
      ...
      "summary": "基督在十字架上滅了冤仇，拆毀了猶太人與外邦人中間隔斷的牆，藉著自己使兩下合而為一，同歸一個身體。",
      ...
      "memoryVerse": {
        "ref": "以弗所書 2:14",
        "text": "因他使我們和睦，將兩下合而為一，拆毀了中間隔斷的牆；"
      }
    },
    {
      "id": "5",
      ...
      "summary": "眾人將行淫時被拿的婦人帶到耶穌面前欲行石頭打死。耶穌說：『你們中間誰是沒有罪的，誰就可以先拿石頭打她。』隨後宣告：『我也不定你的罪，去吧，從此不要再犯罪了！』",
    ...
    },
    {
      ...
      "summary": "保羅為逃跑的奴隸阿尼西母向主人腓利門求情，勸他不再把阿尼西母看作奴僕，而是高於奴僕——看作親愛的主內弟兄。",
    ...
    },
    {
      ...
      "summary": "雅各嚴肅告誡不可按外貌待人、重富輕貧。若按外貌待人便是犯罪，當遵守『愛人如己』這至尊的律法。",
      ...
      "memoryVerse": {
        "ref": "雅各書 2:8–9",
        "text": "經上記著說：「要愛人如己。」你們若全守這至尊的律法，才是好的。但你們若按外貌待人，便是犯罪，被律法定為犯法的。"
      }
    },
    {
      "id": "8",
      ...
      "summary": "神就是愛，住在愛裡面的就是住在神裡面。愛既完全就把懼怕除去；不愛看得見的弟兄，就不能愛看不見的神。",
      ...
      "memoryVerse": {
        "ref": "約翰一書 4:18",
        "text": "愛裡沒有懼怕；愛既完全，就把懼怕除去。因為懼怕裡含著刑罰，懼怕的人在愛裡未得完全。"
      }
    },
    {
      "id": "9",
      ...
      "summary": "摩西重申神的律例：神不以貌取人，也不受賄賂，為孤兒寡婦伸冤，又憐愛寄居的。百姓也當憐愛寄居者，因為曾在埃及作過寄居的。",
      ...
      "memoryVerse": {
        "ref": "申命記 10:19",
        "text": "所以你們要憐愛寄居的，因為你們在埃及地也作過寄居的。"
      }
    },
    {
      "id": "10",
      ...
      "summary": "約翰在異象中看見各國、各族、各民、各方無人能數的大群眾，身穿白衣手拿棕樹枝，在寶座和羔羊面前敬拜讚美。",
