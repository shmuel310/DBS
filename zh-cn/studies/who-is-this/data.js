...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "马可福音探索之旅",
    "titleHtml": "他<br>是<br>谁？",
    "lead": "十周走进马可福音。每周细读一段经文，一同发现耶稣是谁，并肩同行跟随祂——适合小组查经或一对一门训。"
  },
  "methodCopy": {
    "lead": "每周查经都遵循相同的 <strong style=\"color:var(--ink-900);font-weight:600;\">3 个步骤</strong>，次序始终如一，无论两个人还是一组人都适用。预计每次历时约 <strong style=\"color:var(--ink-900);font-weight:600;\">60–90 分钟</strong>，时间仅供参考。",
    "lookBackBlurb": "打开圣经之前，先作一次简短真诚的关顾回顾：上周过得如何、有什么尝试与实践、可以怎样彼此代祷。",
    "lookUpBlurb": "先祷告，然后大声朗读经文，用自己的话重述故事，确保大家都掌握了完整情节。然后由五个核心问题引导深入发现。",
    "lookForwardBlurb": "将你所发现的转化为生命的实际回应：一项行为改变、一个信靠的应许、一个效法的榜样，或者一条顺服的命令。决定这周要向谁分享这段经文，最后在结束前彼此代祷。该对象将成为下周“回顾”的分享内容。",
    "betweenBlurb": "多数周还包括一段自选的个人阅读经文，涵盖小组略过的马可福音故事段落。没有人会检查打卡，纯粹为想在下次聚会前了解更完整脉络的人而设。"
  },
  "finishCopy": {
    "heading": "做得好！",
    "body": "十周，十段经文，一个贯穿始终的问题：他是谁？你们一起回顾、向上看、向前展望，走过了整个旅程。这绝非微不足道的一步，更不是真正的终点。",
    "leadSomeoneElse": "这个课程设计得完全不需要特别培训，这意味着你已经具备带领其他人研读的资格。你已经用了十周与人分享每段经文，他们就是你最自然的第一批邀请对象。准备好的时候，重置你的进度，与他们重新开始吧。",
    "nextStudy": "在不知不觉中，你已经掌握了“发现式查经”（DBS）——一种简单、可复制的读经方式：回顾、向上看、向前展望。继续在你个人灵修或与他人读经时保持这个节奏。《基础入门》和《新生命与真喜乐》（腓立比书）都是极佳的后续课程。"
  },
  "sessions": [
    {
      "id": "1",
    ...
    },
    {
      ...
      "summary": "四个朋友拆通房顶，将一个瘫子缒到耶稣面前。耶稣在医治他的双腿之前先赦免了他的罪——这是惟有神才拥有的权柄。",
    ...
    },
    {
      ...
      "summary": "加利利海上突如其来的风暴，让经验丰富的渔夫们吓得魂飞魄散。耶稣一句话平静了风浪，门徒们不禁问出本课程得名的那个核心问题。",
      ...
      "memoryVerse": {
        "ref": "马可福音 4:41",
        "text": "他们就大大地惧怕，彼此说：“这到底是准，连风和海也听从他了？”"
      }
    },
    {
      "id": "4",
      ...
      "summary": "一个走投无路的父亲，和一个患病十二年的绝望妇人。两个人都跨越重重障碍来到耶稣面前，发现祂的同情心远超他们的想象。",
      ...
      "memoryVerse": {
        "ref": "马可福音 5:34",
        "text": "耶稣对她说：“女儿，你的信救了你，平平安安地回去吧！你的灾病痊愈了。”"
      }
    },
    {
      "id": "5",
      ...
      "summary": "在偏僻荒野，五千人又累又饿。门徒想叫众人散去，但耶稣拿着五个饼两条鱼祝谢，门徒亲自分给众人，所有人都吃饱了。",
    ...
    },
    {
      ...
      "summary": "在凯撒利亚腓立比的路上，耶稣问门徒：你们说我是谁？彼得给出正确的答案，但耶稣紧接着预告自己的受难，并阐明跟从祂的真正代价。",
    ...
    },
    {
      ...
      "summary": "当耶稣走向耶路撒冷的十字架时，雅各和约翰却在争夺最高的位置。耶稣以自己的生命定义了真正的伟大：服事人，而非受人服事。",
      ...
      "memoryVerse": {
        "ref": "马可福音 10:45",
        "text": "“因为人子来，并不是要受人的服事，乃是要服事人，并且要舍命作多人的赎价。”"
      }
    },
    {
      "id": "8",
      ...
      "summary": "一位文士问耶稣诫命中哪一条是第一要紧的。耶稣的回答将所有宗教规条精简为两个方向的爱：尽心爱神，爱人如己。",
    ...
    },
    {
      ...
      "summary": "最后晚餐中设立的饼与杯，随后在客西马尼园中极其痛苦的祷告。门徒睡着了，耶稣独自顺服父神的旨意。",
      ...
      "memoryVerse": {
        "ref": "马可福音 14:36",
        "text": "他说：“阿爸！父啊！在你凡事都能；求你将这杯撤去。然而，不要从我的意思，只要从你的意思。”"
      }
    },
    {
      "id": "10",
      ...
      "summary": "钉十字架、断气、安葬，随后在清晨发现的空坟墓。马可福音以惊叹、敬畏与一个尚未终结的故事结束。",
      ...
      "memoryVerse": {
        "ref": "马可福音 16:6",
        "text": "那少年人对她们说：“不要惊恐！你们寻找那钉十字架的拿撒勒人耶稣，他已经复活了，不在这里。请看安放他的地方。”"
      }
    }
  ],
  "bonusSessions": [
    {
      ...
      "bonus": true,
      "fitsAfter": "适合在第 2 周（谁能赦罪？）之后进行",
      "summary": "耶稣上山随自己意思叫人来，设立了十二使徒，要他们常和自己同在，也差他们去传道并赐权柄赶鬼。",
    ...
    },
    {
      ...
      "bonus": true,
      "fitsAfter": "适合在第 3 周（他是谁？）之后进行",
      "summary": "耶稣在海边教导撒种的比喻：道撒在路旁、土浅石头地、荆棘里，以及结实百倍的好土上。",
      ...
      "memoryVerse": {
        "ref": "马可福音 4:20",
        "text": "“那撒在好地上的，就是人听道，又领受，并且结实，有三十倍的，有六十倍的，有一百倍的。”"
      }
    },
    {
      "id": "B3",
      ...
      "bonus": true,
      "fitsAfter": "适合在第 3 周（他是谁？）之后进行",
      "summary": "格拉森被群鬼附身的人获释得救。耶稣吩咐他回家去，将主为他做何等大的事都告诉亲友。",
      ...
      "memoryVerse": {
        "ref": "马可福音 5:19",
        "text": "耶稣不许，却对他说：“你回家去，到你的亲属那里，将主为你所做的是何等大的事，是怎样怜悯你，都告诉他们。”"
      }
    },
    {
      "id": "B4",
      ...
      "bonus": true,
      "fitsAfter": "适合在第 6 周（我是谁？）之后进行",
      "summary": "耶稣清楚说明跟从祂的要求：舍己，背起自己的十字架来跟从祂，人若赚得全世界赔上生命有何益处。",
    ...
    },
    {
      ...
      "bonus": true,
      "fitsAfter": "适合在第 6 周（我是谁？）之后进行",
      "summary": "登山变貌，耶稣在门徒面前显出荣光，摩西、以利亚显现，云彩中有声音说：这是我的爱子，你们要听他。",
      ...
      "memoryVerse": {
        "ref": "马可福音 9:7",
        "text": "有一朵云彩来遮盖他们；也有声音从云彩里出来，说：“这是我的爱子，你们要听他。”"
      }
    },
    {
      "id": "B6",
      ...
      "bonus": true,
      "fitsAfter": "适合在第 7 周（并非受人服事）之后进行",
      "summary": "讨饭的瞎子巴底买呼求大卫的子孙。耶稣问他：你要我为你做什么？他立时看见，在路上跟随耶稣。",
      ...
      "memoryVerse": {
        "ref": "马可福音 10:52",
        "text": "耶稣说：“你去吧！你的信救了你了。”盲人立刻看见了，就在路上跟随耶稣。"
      }
    },
    {
      "id": "B7",
      ...
      "bonus": true,
      "fitsAfter": "适合在第 7 周（并非受人服事）之后进行",
      "summary": "耶稣骑着驴驹进耶路撒冷，众人喊和散那；随后进殿赶出做买卖的人，宣明我的殿必称为万国祷告的殿。",
      ...
      "memoryVerse": {
        "ref": "马可福音 11:9",
        "text": "前行后随的人都喊着说：“和散那！奉主名来的是应当称颂的！”"
      }
    },
    {
      "id": "B8",
      ...
      "bonus": true,
      "fitsAfter": "适合在第 9 周（晚餐与园子）之后进行",
      "summary": "大祭司审问耶稣，耶稣宣告自己是神子；外院的彼得却在使女面前三次不敢承认主，随后痛哭。",
      ...
      "memoryVerse": {
        "ref": "马可福音 14:62",
        "text": "耶稣说：“我是。你们必看见人子坐在那权能者的右边，驾着天上的云降临。”"
      }
    }
  ]
};
