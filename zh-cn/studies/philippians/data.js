...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "腓立比书探索之旅",
    "titleHtml": "新生命与真喜乐",
    "lead": "保罗在狱中所写下满溢喜乐的书信。六周走进腓立比书，发现超越环境的平安、在基督里的合一与真正的生命喜乐。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "真正的喜乐",
    "body": "六周细读腓立比书，我们发现喜乐不是来自无忧无虑的环境，而是深植于基督耶稣里的平安与信靠。",
    "leadSomeoneElse": "你已经掌握了带领这个课程的方式，随时可以邀请下一位朋友开始。",
    "nextStudy": "《路得记》或《学习跟随耶稣》都是极佳的后续课程。"
  },
  "sessions": [
    {
      "id": "1",
    ...
    },
    {
      ...
      "summary": "保罗表明自己的遭遇反而叫福音兴旺。无论生死，总叫基督在他身上照常显大；因他活着就是基督，死了就有益处。",
    ...
    },
    {
      ...
      "summary": "基督耶稣本有神的形象，却虚己取了奴仆的形象，存心顺服以至于死，且死在十字架上。神将祂升为至高，万膝必向祂跪拜。",
      ...
      "memoryVerse": {
        "ref": "腓立比书 2:9–11",
        "text": "所以，神将他升为至高，又赐给他那超乎万名之上的名，叫一切在天上的、地上的，和地底下的，因耶稣的名无不屈膝，无不口称“耶稣基督为主”，使荣耀归与父神。"
      }
    },
    {
      "id": "4",
      ...
      "summary": "当恐惧战兢做成得救的工夫，因为是神在心里运行。保罗称赞提摩太和以巴弗提，他们顾念基督的事，甚至不顾性命。",
      ...
      "memoryVerse": {
        "ref": "腓立比书 2:13",
        "text": "因为你们立志行事都是神在你们心里运行，为要成全他的美意。"
      }
    },
    {
      "id": "5",
      ...
      "summary": "保罗将昔日引以为傲的宗教履历都看作粪土，为要得着基督，并晓得祂复活的大能，忘记背后努力面前向着标竿直跑。",
      ...
      "memoryVerse": {
        "ref": "腓立比书 3:9",
        "text": "并且得以在他里面，不是有自己因律法而得的义，乃是有信基督的义，就是因信神而来的义。"
      }
    },
    {
      "id": "6",
      ...
      "summary": "应当一无挂虑，凡事借祷告交托神，神出人意外的平安必保守心怀意念。保罗学会了处卑贱与富足的秘诀：靠着爱他的主凡事都能做。",
