...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "从永恒之约到荣耀再临",
    "titleHtml": "神的国度",
    "lead": "十二周的圣经全景探索。从亚伯拉罕之约到启示录终极的得胜，发现神的国度如何在历史中展开，并在基督耶稣里完全成就。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "国度永存",
    "body": "十二课纵览神国度的宏伟蓝图。我们已迁入爱子的国度，带着君尊祭司的荣耀身份活在世上。",
    "leadSomeoneElse": "你已经掌握了带领这个课程的方式，随时可以邀请下一位朋友开始。",
    "nextStudy": "《登山宝训》或《他是谁？》都是极佳的后续课程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "memoryVerse": {
        "ref": "创世记 17:7",
        "text": "“我要与你并你世世代代的后裔坚立我的约，作永远的约，是要作你和你后裔的神。”"
      }
    },
    {
      "id": "2",
      ...
      "summary": "摩西在西奈山听见神的宣告：全地都是属我的，你们若听从我的话遵守我的约，就要在万民中作属我的子民，成为祭司的国度与圣洁的国民。",
      ...
      "memoryVerse": {
        "ref": "出埃及记 19:5–6",
        "text": "“如今你们若实在听从我的话，遵守我的约，就要在万民中作属我的子民，因为全地都是我的。你们要归我作祭司的国度，为圣洁的国民。”"
      }
    },
    {
      "id": "3",
      ...
      "summary": "但以理为尼布甲尼撒王解大像之梦：金银铜铁泥的各国终必过去，有一块非人手凿出的石头打碎大像变成大山充满天下，神必另立一永不败坏的国度。",
      ...
      "memoryVerse": {
        "ref": "但以理书 2:44",
        "text": "“当那列王在位显然的时候，天上的神必另立一国，永不败坏，也不归别国的人，却要打碎灭绝那一切国，这国必存到永远。”"
      }
    },
    {
      "id": "4",
      ...
      "summary": "在黑暗中行走的百姓看见了大光。先知预言有一婴孩为我们而生，政权必担在祂的肩头上，祂的国度必以公平公义坚定直到永远。",
      ...
      "memoryVerse": {
        "ref": "以赛亚书 9:6",
        "text": "因有一婴孩为我们而生；有一子赐给我们。政权必担在他的肩头上；他名称为“奇妙策士、全能的神、永在的父、和平的君”。"
      }
    },
    {
      "id": "5",
      ...
      "summary": "约翰下监后，耶稣来到加利利宣传神的福音：日期满了，神的国近了！你们当悔改，信福音。这正是国度君王的降临宣召。",
    ...
    },
    {
      ...
      "summary": "天国好像人撒好种在田里，仇敌来撒了稗子。收割之前容两样一齐长，世界的末了天使要薅出稗子用火焚烧，义人在父的国里要发出光来。",
      ...
      "memoryVerse": {
        "ref": "马太福音 13:43",
        "text": "“那时，义人在他们父的国里，要发出光来，像太阳一样。有耳可听的，就应当听！”"
      }
    },
    {
      "id": "7",
      ...
      "summary": "天国好像藏在田里的宝贝，又像贵重珍珠，人欢欢喜喜变卖一切所有的去买它；天国又如撒网聚拢各样水族，好的收在器具里，不好的丢弃。",
    ...
    },
    {
      ...
      "summary": "彼得认信耶稣是基督、是永生神的儿子。耶稣宣告要把教会建造在这磐石上，阴间的权柄不能胜过它，并赐下天国的钥匙。",
    ...
    },
    {
      ...
      "summary": "彼拉多审问耶稣是否为犹太人的王。耶稣回答：‘我的国不属这世界；我的国若属这世界，我的臣仆必要争战。我为此而生，也为此来到世间。’",
      ...
      "memoryVerse": {
        "ref": "约翰福音 18:36",
        "text": "耶稣回答说：“我的国不属这世界；我的国若属这世界，我的臣仆必要争战，使我不至于被交给犹太人。只是我的国不属这世界。”"
      }
    },
    {
      "id": "10",
      ...
      "summary": "耶稣受难复活后四十天向门徒讲论神国的事。祂吩咐门徒不要离开耶路撒冷，等候圣灵降临得着能力，在全地作祂的见证直等到祂再来。",
      "lookUpPrayer": "Try praying a full sentence or two this week: name what came up in Look Back, then ask the Holy Spirit to reveal something as you read.",
      ...
      "memoryVerse": {
        "ref": "使徒行传 1:8",
        "text": "“但圣灵降临在你们身上，你们就必得着能力，并要在耶路撒冷、犹太全地，和撒玛利亚，直到地极，作我的见证。”"
      }
    },
    {
      "id": "11",
      ...
      "summary": "父神救了我们脱离黑暗的权势，把我们迁到祂爱子的国里；我们在爱子里得蒙救赎，罪过得以赦免。祂是教会的全体之首。",
      "lookUpPrayer": "Pray honestly about what surfaced in Look Back, even the hard parts, then ask the Holy Spirit to help this passage land.",
    ...
    },
    {
      ...
      "summary": "第七位天使吹号，天上有大声音说：世上的国成了我主和主基督的国；祂要作王，直到永永远远！二十四位长老面伏于地敬拜赞美全能者。",
      ...
      "memoryVerse": {
        "ref": "启示录 11:15",
        "text": "第七位天使吹号，天上就有大声音说：“世上的国成了我主和主基督的国；他要作王，直到永永远远。”"
      }
    }
  ]
};
