...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "门徒成长的八个关键",
    "titleHtml": "学习跟随耶稣",
    "lead": "为初信者和渴望扎根的门徒而设。八次聚会涵盖门训、洗礼、祷告、与主连结、爱神爱人、坚忍、圣餐及合一。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "扎根成长",
    "body": "八个根基，指引我们如何一生跟随耶稣，作忠心传承的门徒。",
    "leadSomeoneElse": "你已经掌握了带领这个课程的方式，随时可以邀请下一位朋友开始。",
    "nextStudy": "《耶稣的吩咐》或《接触、得着、建立、培训、差遣》都是极佳的后续课程。"
  },
  "sessions": [
    {
      "id": "1",
    ...
    },
    {
      ...
      "summary": "腓利顺服圣灵带领向埃提阿伯太监传讲耶稣，太监信而受洗。耶稣吩咐使万民作门徒，奉父子圣灵的名给他们施洗。",
    ...
    },
    {
      ...
      "summary": "门徒求耶稣教导祷告，耶稣传授主祷文，并应许祈求就得着、寻找就寻见、叩门就给你们开门，天父必将圣灵赐给求祂的人。",
    ...
    },
    {
      ...
      "summary": "耶稣是真葡萄树，我们是枝子。常在祂里面的，祂也常在我们里面，这人就多结果子；因为离了祂，我们不能做什么。",
    ...
    },
    {
      ...
      "summary": "好撒玛利亚人的比喻：打破隔阂去怜悯受伤的人。相爱不要只在言语和舌头上，总要在行为和诚实上。",
    ...
    },
    {
      ...
      "summary": "使徒受公会审讯鞭打，反倒欢喜，因被算是配为这名受辱。为主的名受苦不是可耻的事，倒要归荣耀给神。",
    ...
    },
    {
      ...
      "summary": "主设立圣餐：这是我为你们舍的身体，这杯是用我的血所立的新约。信徒恒心遵守使徒的教训，擘饼、祈祷、彼此交接。",
    ...
    },
    {
      ...
      "summary": "初代教会信徒天天同心合意，存着欢喜诚实的心用饭，赞美神，得众民的喜爱。耶稣祈求所有信祂的人合而为一，叫世人信祂。",
      ...
      "memoryVerse": {
        "ref": "约翰福音 17:21",
        "text": "“使他们合而为一。正如你父在我里面，我在你里面，使他们也在我们里面，叫世人可以信你差了我来。”"
      }
    }
  ]
};
