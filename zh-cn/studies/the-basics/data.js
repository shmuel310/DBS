...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "从创世记到福音书",
    "titleHtml": "基<br>础<br>入<br>门",
    "lead": "十课纵览圣经宏大故事：从创世、堕落，到十字架与复活。每次细读一段经文，发现神贯穿始终的心意，并肩同行作出生命回应——适合小组或一对一门训。"
  },
  "methodCopy": {
    "lead": "每课查经都遵循相同的 <strong style=\"color:var(--ink-900);font-weight:600;\">3 个步骤</strong>，次序始终如一，无论两个人还是一组人都适用。预计每次历时约 <strong style=\"color:var(--ink-900);font-weight:600;\">90 分钟</strong>，若时间紧凑，60 分钟亦完全可行。",
    "lookBackBlurb": "互相重新连结的时刻：这星期你如何经历神、有什么感恩、有什么难处，以及上次所学的心得在生活中如何实际落实。",
    "lookUpBlurb": "大声朗读经文，用自己的话重述故事，确保大家都掌握了完整情节。然后由几个核心问题引导深入发现。",
    "lookForwardBlurb": "将你所发现的转化为生命的实际回应：一项行为改变、一个信靠的应许、一个效法的榜样，或者一条顺服的命令。然后设立一个明确具体的行动目标（何时之前、做什么、为什么重要），决定这周要向谁分享这段经文，最后在结束前彼此代祷。",
    "respondItems": [
      "改变一项行为？",
      "信靠一个应许？",
      "效法一个榜样？",
  ...
  "finishCopy": {
    "heading": "新生命",
    "body": "十课历程，从伊甸园到空坟墓，一个关于神是谁、人如何偏离，以及神如何拯救的伟大故事。你们一起回顾、向上看、向前展望，走过了整个旅程。这绝非微不足道的一步，正如最后一课所言，这是生命崭新的开端，而非终结。",
    "leadSomeoneElse": "这个课程设计得完全不需要特别培训，这意味着你已经具备带领其他人研读的资格。你在这些课程中与人分享每段经文，他们就是你最自然的第一批邀请对象。准备好的时候，重置你的进度，与他们重新开始吧。",
    "nextStudy": "在不知不觉中，你已经掌握了“发现式查经”（DBS）——一种简单、可复制的读经方式：回顾、向上看、向前展望。继续在你个人灵修或与他人读经时保持这个节奏。《他是谁？》（马可福音）是极佳的后续课程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "memoryVerse": {
        "ref": "创世记 2:7",
        "text": "耶和华神用地上的尘土造人，将生气吹在他鼻孔里，他就成了有灵的活人，名叫亚当。"
      }
    },
    {
      "id": "2",
      ...
      "summary": "蛇诱骗夏娃与亚当怀疑神，吃了吩咐不可吃的分别善恶树果子。羞耻、推卸责任，以及与神与彼此的隔绝随之临到。",
    ...
    },
    {
      ...
      "summary": "人类罪恶蔓延，神为造人而忧伤，决定用洪水审判大地。惟有挪亚蒙恩称为义人，建造方舟保全全家与活物。",
    ...
    },
    {
      ...
      "summary": "神将以色列民从埃及为奴之家拯救出来后，在西奈山颁布十诫，奠定人与神、人与人同处的核心约定。",
      ...
      "memoryVerse": {
        "ref": "出埃及记 20:2–3",
        "text": "“我是耶和华——你的神，曾将你从埃及地为奴之家领出来。除了我以外，你不可有别的神。”"
      }
    },
    {
      "id": "5",
      ...
      "summary": "扫罗王背离神后，神差撒母耳膏立少年大卫为以色列未来的王。神看人不像人看人，神是看内心。",
      ...
      "memoryVerse": {
        "ref": "撒母耳记上 16:7",
        "text": "耶和华对撒母耳说：“不要看他的外貌和他身材高大，我不拣选他。因为耶和华不像人看人：人是看外貌；耶和华是看内心。”"
      }
    },
    {
      "id": "6",
      ...
      "summary": "先知以赛亚预言一位受苦的仆人，因我们的过犯受害，担当我们的罪孽，神使我们众人的罪孽都归在祂身上。",
    ...
    },
    {
      ...
      "summary": "耶稣降生在伯利恒的马槽中。天使向野地看守羊群的牧羊人报大喜的信息：今天为你们生了救主，就是主基督。",
      ...
      "memoryVerse": {
        "ref": "路加福音 2:10–11",
        "text": "那天使对他们说：“不要惧怕！我报给你们大喜的信息，是关乎万民的；因今天在大卫的城里，为你们生了救主，就是主基督。”"
      }
    },
    {
      "id": "8",
      ...
      "summary": "耶稣路过耶利哥，主动走进税吏长撒该的家。撒该生命彻底改变，耶稣宣明人子来是为寻找拯救失丧的人。",
    ...
    },
    {
      ...
      "summary": "耶稣被戏弄、鞭打，钉在罗马十字架上。殿里的幔子从上到下裂为两半，百夫长见证：“这人真是神的儿子！”",
      ...
      "memoryVerse": {
        "ref": "马可福音 15:39",
        "text": "对面站着的百夫长看见耶稣这样气绝，就说：“这人真是神的儿子！”"
      }
    },
    {
      "id": "10",
      ...
      "summary": "妇女清晨来到坟墓，看见石头已经挪开，天使宣告基督已复活。耶稣向门徒显现，颁布使万民作门徒的大使命。",
      ...
      "memoryVerse": {
        "ref": "马太福音 28:5–6",
        "text": "天使对妇女说：“不要害怕！我知道你们是寻找那钉十字架的耶稣。他不在这里，照他所说的，已经复活了。你们来看安放主的地方。”"
      }
    }
  ]
};
