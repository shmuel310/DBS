...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "恩典与救赎的旅程",
    "titleHtml": "路得记",
    "lead": "一个关于丧失、忠诚与救赎的动人故事。五次研读走过士师时代这段美丽的历史，见证神的恩惠如何默默引导人的脚步。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "救赎的恩典",
    "body": "五课走过路得记，看见神在平凡的日子里编织伟大的救赎。祂从不撇弃投靠祂翅膀底下的人。",
    "leadSomeoneElse": "你已经掌握了带领这个课程的方式，随时可以邀请下一位朋友开始。",
    "nextStudy": "《学习跟随耶稣》或《耶稣的吩咐》都是极佳的后续课程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "memoryVerse": {
        "ref": "路得记 1:16",
        "text": "路得说：“不要催我回去不跟随你。你往哪里去，我也往哪里去；你在哪里住宿，我也在哪里住宿；你的国就是我的国，你的神就是我的神。”"
      }
    },
    {
      "id": "2",
      ...
      "summary": "路得为奉养婆婆，恰巧来到亲族波阿斯的田间拾麦穗。波阿斯厚待外邦女子路得，称赞她孝敬婆婆并投靠耶和华翅膀地下的忠信。",
      ...
      "memoryVerse": {
        "ref": "路得记 2:12",
        "text": "“愿耶和华照你所行的赏赐你。你来投靠耶和华——以色列神的翅膀下，愿你满得他的赏赐。”"
      }
    },
    {
      "id": "3",
      ...
      "summary": "拿俄米为路得寻求安身之处，指导路得夜间前往麦场。波阿斯惊醒，答应承担至亲救赎者的责任，称赞路得是个贤德的女子。",
      ...
      "memoryVerse": {
        "ref": "路得记 3:9",
        "text": "他就说：“你是谁？”回答说：“我是你的婢女路得。求你用你的衣襟遮盖我，因为你是我一个至近的亲属。”"
      }
    },
    {
      "id": "4",
      ...
      "summary": "波阿斯在城门口长老面前，公开询问更近的亲属；那人放弃赎产权利后，波阿斯正式赎买以利米勒的产业，并迎娶路得为妻。",
      ...
      "memoryVerse": {
        "ref": "路得记 4:10",
        "text": "“我又娶了玛伦的妻摩押女子路得为妻，好在死人的产业上存留他的名，免得他的名在弟兄中、在本乡灭没。你们今日可以作见证。”"
      }
    },
    {
      "id": "5",
      ...
      "summary": "耶和华使路得怀孕生子俄备得。妇人们向拿俄米祝贺神不绝恩惠，俄备得后来生耶西，耶西生大卫王。神的美意成全了救赎世系。",
      ...
      "memoryVerse": {
        "ref": "路得记 4:14–15",
        "text": "妇人们对拿俄米说：“耶和华是应当称颂的！因为今日没有撇下你，使你没有至近的亲属。愿这孩子在以色列中得名声。他必提起你的精神，奉养你的老，因为是爱慕你的那儿妇所生的。有这儿妇比有七个儿子还好！”"
      }
    }
  ]
};
