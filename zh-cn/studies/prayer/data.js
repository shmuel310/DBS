...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "与天父亲密的对话",
    "titleHtml": "教导我们祷告",
    "lead": "深入十段关于祈祷的圣经经文。从主祷文到客西马尼园的呼求，学习坦然无惧来到恩典的宝座前，与神建立活泼深邃的祷告生命。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "不住的祷告",
    "body": "十课祷告之旅，引导我们敞开心扉与天父相交。祂必垂听呼求，赐下随时的恩惠。",
    "leadSomeoneElse": "你已经掌握了带领这个课程的方式，随时可以邀请下一位朋友开始。",
    "nextStudy": "《天国的奥秘》或《登山宝训》都是极佳的后续课程。"
  },
  "sessions": [
    {
      "id": "1",
    ...
    },
    {
      ...
      "summary": "耶稣设不义之官与穷寡妇的比喻，教导人应当常常祷告，不可灰心。神岂不更要给祂昼夜呼吁的选民伸冤吗？",
    ...
    },
    {
      ...
      "summary": "彼得被收在监里，教会为他切切地祷告神。天使夜间拍醒彼得，铁门自动打开，神施行拯救脱离希律的手。",
    ...
    },
    {
      ...
      "summary": "应当一无挂虑，凡事借着祷告、祈求和感谢将所要的告诉神。神出人意外的平安必保守心怀意念。",
    ...
    },
    {
      ...
      "summary": "保罗在父面前屈膝，求神借着圣灵使信徒心里的力量刚强起来，使基督因信住在心里，明白基督的爱何等长阔高深。",
      ...
      "memoryVerse": {
        "ref": "以弗所书 3:20–21",
        "text": "神能照着运行在我们心里的大力充充足足地成就一切，超过我们所求所想的。但愿他在教会中，并在基督耶稣里，得着荣耀，直到世世代代，永永远远。阿们！"
      }
    },
    {
      "id": "6",
      ...
      "summary": "耶稣在客西马尼园极其忧伤祷告：‘我父啊，倘若可行，求你叫这杯离开我。然而，不要照我的意思，只要照你的意思。’",
      "lookUpPrayer": "Pray about what came up in Look Back, then ask the Holy Spirit to help you understand what you&rsquo;re about to read.",
      ...
      "memoryVerse": {
        "ref": "马太福音 26:39",
        "text": "他就稍往前走，俯伏在地，祷告说：“我父啊，倘若可行，求你叫这杯离开我。然而，不要照我的意思，只要照你的意思。”"
      }
    },
    {
      "id": "7",
      ...
      "summary": "我们的软弱有圣灵帮助。我们本不晓得当怎样祷告，只是圣灵亲自用说不出来的叹息替我们祈求，鉴察人心的神晓得圣灵的意思。",
      "lookUpPrayer": "Bring what you just shared to God, then ask the Holy Spirit to reveal something in this passage you might otherwise miss.",
      ...
      "memoryVerse": {
        "ref": "罗马书 8:26",
        "text": "况且，我们的软弱有圣灵帮助；我们本不晓得当怎样祷告，只是圣灵亲自用说不出来的叹息替我们祈求。"
      }
    },
    {
      "id": "8",
      ...
      "summary": "门徒遭恐吓后聚在一处祷告，求主赐大胆量讲论真道并医治显神迹。祷告完了，聚会的地方震动，众人被圣灵充满放胆讲道。",
      "lookUpPrayer": "Pray for each other about whatever came up in Look Back, then invite the Holy Spirit to open your eyes as you read.",
      ...
      "memoryVerse": {
        "ref": "使徒行传 4:31",
        "text": "祷告完了，聚会的地方震动，他们就都被圣灵充满，放胆讲论神的道。"
      }
    },
    {
      "id": "9",
      ...
      "summary": "哈拿因不能生育心里愁苦，在耶和华面前痛痛哭泣祈祷，倾心吐意。以利给予祝福，神眷顾哈拿生下撒母耳。",
      "lookUpPrayer": "Pray about what&rsquo;s come up so far, then ask the Holy Spirit to help you see this passage clearly.",
      ...
      "memoryVerse": {
        "ref": "撒母耳记上 1:27",
        "text": "“我祈求为要得这孩子；耶和华已将我向他所求的赐给我了。”"
      }
    },
    {
      "id": "10",
      ...
      "summary": "你们要恒切祷告，在此警醒感恩；也要为传道人祈求，求神给我们开传道的门，能以宣扬基督的奥秘。",
