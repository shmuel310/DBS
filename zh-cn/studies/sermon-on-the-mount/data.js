...
window.STUDY = {
  ...
  "sessionsLabel": "八周",
  "welcomeCopy": {
    "tagline": "马太福音 5–7 章的天国宪章",
    "titleHtml": "登山宝训",
    "lead": "耶稣在山上所传授最深刻著名的天国宪章。八周细读八福、光与盐、更深的公义、隐密处的敬虔，以及建立在磐石上的生命。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "建立在磐石上",
    "body": "八周登山宝训，塑造我们成为听道且行道的人。将生命建造在基督的磐石上，永不动摇。",
    "leadSomeoneElse": "你已经掌握了带领这个课程的方式，随时可以邀请下一位朋友开始。",
    "nextStudy": "《他是谁？》或《接触、得着、建立、培训、差遣》都是极佳的后续课程。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "summary": "耶稣上山开口教导门徒八福：虚心、哀恸、温柔、饥渴慕义、怜恤人、清心、使人和睦、为义受逼迫。天国完全颠覆了世人的价值观。",
      "lookBack": {
    ...
    },
    {
      ...
      "summary": "你们是世上的盐、世上的光。光当照在人前，荣耀归给天父。耶稣来不是要废掉律法和先知，乃是要成全。",
    ...
    },
    {
      ...
      "summary": "从向弟兄动怒、眼目淫念，到起誓、爱仇敌。耶稣剖开律法的字句直指内心深处的动机：你们要完全，像你们的天父完全一样。",
      ...
      "memoryVerse": {
        "ref": "马太福音 5:44",
        "text": "“只是我告诉你们，要爱你们的仇敌，为那逼迫你们的祷告。”"
      }
    },
    {
      "id": "4",
      ...
      "summary": "不可将善事行在人前故意叫人看见。无论施舍、祷告或禁食，都要行在暗中，你父在暗中察看，必然报答你。耶稣亲授主祷文。",
      ...
      "memoryVerse": {
        "ref": "马太福音 6:9–10",
        "text": "“所以，你们祷告要这样说：‘我们在天上的父：愿人都尊你的名为圣。愿你的国降临；愿你的旨意行在地上，如同行在天上。’”"
      }
    },
    {
      "id": "5",
      ...
      "summary": "不要为自己积攒财宝在地上，只要积攒在天上；你的财宝在哪里，你的心也在哪里。不要为明天忧虑，先求神的国和祂的义。",
    ...
    },
    {
      ...
      "summary": "你们不要论断人免得被论断。先去掉自己眼中的梁木。祈求就得着，叩门就开门。无论何事，你们愿意人怎样待你们，你们也要怎样待人。",
    ...
    },
    {
      ...
      "summary": "你们要进窄门。引到灭亡的门是宽的路是大的，进去的人也多；引到永生，门是窄的路是小的，找着的人也少。防备假先知，看果子认树。",
      ...
      "memoryVerse": {
        "ref": "马太福音 7:14",
        "text": "“引到灭亡，那门是宽的，路是大的，进去的人也多；引到永生，那门是窄的，路是小的，找着的人也少。”"
      }
    },
    {
      "id": "8",
      ...
      "summary": "凡听见耶稣这话就去行的，好比一个聪明人把房子盖在磐石上；风吹雨淋总不倒塌。众人都希奇祂的教训，因为祂教导像有权柄的人。",
      ...
      "memoryVerse": {
        "ref": "马太福音 7:24",
        "text": "“所以，凡听见我这话就去行的，好比一个聪明人，把房子盖在磐石上；”"
      }
    }
  ]
};
