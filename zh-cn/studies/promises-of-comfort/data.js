...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "患难中的安息与盼望",
    "titleHtml": "10个安慰的应许",
    "lead": "十个给予心灵力量的圣经应许。无论面对焦虑、孤单、软弱抑或失去，神信实的话语都是我们最坚固的避难所与随时的帮助。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "满有安慰",
    "body": "十个应许，承载着神永不改变的慈爱与信实。祂的平安超越世人的一切理解。",
    "leadSomeoneElse": "你已经掌握了带领这个课程的方式，随时可以邀请下一位朋友开始。",
    "nextStudy": "《教导我们祷告》或《天国的奥秘》都是极佳的后续课程。"
  },
  "sessions": [
    {
      "id": "1",
    ...
    },
    {
      ...
      "summary": "大卫深知耶和华已经鉴察我、认识我。我往哪里去躲避你的灵？神在母腹中覆庇我，我的受造奇妙可畏，神深切看顾每一刻。",
      ...
      "memoryVerse": {
        "ref": "希伯来书 13:5",
        "text": "你们存心不可贪爱钱财，要以自己所有的为足；因为主曾说：“我总不撇下你，也不丢弃你。”"
      }
    },
    {
      "id": "3",
      ...
      "summary": "五饼二鱼喂饱五千人。在门徒看为绝不可能之处，耶稣行出神迹，显明神恩典的供应远超我们所求所想，甚至装满十二个篮子。",
    ...
    },
    {
      ...
      "summary": "遮掩过犯的必不亨通，承认离弃罪过的必蒙怜恤。当大卫闭口不认罪时骨头枯干，向神陈明罪愆后得蒙赦免，得着救恩的乐歌。",
    ...
    },
    {
      ...
      "summary": "两个心灰意冷的门徒往以马忤斯去，复活的耶稣亲自就近同行，沿途讲解圣经。直到擘饼时他们眼睛明亮认出祂来，心里火热。",
    ...
    },
    {
      ...
      "summary": "你们中间有受苦的呢，他就该祷告；有喜乐的呢，他就该歌颂。出于信心的祈祷要救那病人，义人祈祷所发的力量是大有功效的。",
      "lookUpPrayer": "Pray about what came up in Look Back, then ask the Holy Spirit to help you understand what you&rsquo;re about to read.",
      ...
      "memoryVerse": {
        "ref": "约翰福音 15:7",
        "text": "“你们若常在我里面，我的话也常在你们里面，凡你们所愿意的，祈求，就给你们成就。”"
      }
    },
    {
      "id": "7",
      ...
      "summary": "你们心里不要忧愁；你们信神，也当信我。在我父的家里有许多住处，我去原是为你们预备地方去，必再來接你们到我那里去。",
      "lookUpPrayer": "Bring what you just shared to God, then ask the Holy Spirit to reveal something in this passage you might otherwise miss.",
    ...
    },
    {
      ...
      "summary": "保罗肉体上有一根刺，三次求主叫这刺离开。主对他说：‘我的恩典够你用的，因为我的能力是在人的软弱上显得完全。’",
      "lookUpPrayer": "Pray for each other about whatever came up in Look Back, then invite the Holy Spirit to open your eyes as you read.",
    ...
    },
    {
      ...
      "summary": "大卫夜观星空赞叹：人算什么，你竟顾念他！世人算什么，你竟眷顾他！神赐人荣耀尊贵为冠冕，派人管理祂手所造的万物。",
    ...
    },
    {
      ...
      "summary": "我们既因信称义，就借着主耶稣基督得与神相和。不但如此，就是在患难中也是欢欢喜喜的，因为知道患难生忍耐，盼望不至于羞耻。",
      "lookUpPrayer": "Pray about everything this course has stirred up in you, then ask the Holy Spirit to help you see where he&rsquo;s been quietly at work in your own story too.",
      ...
      "memoryVerse": {
        "ref": "约翰福音 16:24",
        "text": "“向来你们没有求过什么，如今你们求，就必得着，叫你们的喜乐可以满足。”"
      }
    }
  ]
};
