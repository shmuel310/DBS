...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "希望をたどる旅",
    "titleHtml": "10の希望の物語",
    "lead": "聖書に記された10の物語。絶望や拒絶、傷つきの中にある人々に、イエスがどのように揺るぎない希望をもたらされたかを発見します。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "希望に満ちて",
    "body": "10の物語を通して、希望の真の力を体験しました。イエスの恵みと憐れみは尽きることがありません。",
    "leadSomeoneElse": "あなた自身がすでに次の人を導く準備ができています。準備ができたら誰かを誘って再スタートしましょう。",
    "nextStudy": "『この方は誰なのか？』や『キリスト者の基礎』に進むのがおすすめです。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 2:17",
        "text": "「医者を必要とするのは、丈夫な人ではなく病人です。わたしが来たのは、正しい人を招くためではなく、罪人を招くためです。」"
      }
    },
    {
      "id": "2",
      ...
      "summary": "ファリサイ派のニコデモが夜イエスを訪ねます。イエスは水と御霊による新しく生まれる神秘を語り、神の愛の約束を明らかにされます。",
    ...
    },
    {
      ...
      "summary": "ゲラサの地で悪霊に支配されていた人が完全に解放されます。イエスは彼に、家に帰って主がしてくださった大いなる憐れみを告げ知らせるよう命じられます。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 5:15",
        "text": "彼らがイエスのところに来ると、悪霊につかれていた人が、服を着て正気になって座っていた。彼らは恐ろしくなった。"
      }
    },
    {
      "id": "4",
      ...
      "summary": "罪深い女がイエスの足に涙を注ぎ、香油を塗ります。多く赦された者は多く愛するという主の豊かな赦しが宣言されます。",
    ...
    },
    {
      ...
      "summary": "財産を使い果たした放蕩息子が我に返り父の元へ帰ります。父は走って抱きしめ、失われた者が生き返った喜びの宴会を開きます。",
      ...
      "memoryVerse": {
        "ref": "ルカの福音書 15:20",
        "text": "こうして彼は立ち上がって、自分の父のもとへ向かった。ところが、まだ家までは遠いのに、父親は彼を見つけて深く憐れみ、駆け寄って彼の首を抱き、口づけした。"
      }
    },
    {
      "id": "6",
      ...
      "summary": "10人の重い皮膚病を患う人が癒やされますが、戻って大声で神を賛美し感謝したのはサマリア人1人だけでした。信仰が彼を救いました。",
      ...
      "memoryVerse": {
        "ref": "ルカの福音書 17:19",
        "text": "そして、その人に言われた。「立ち上がって、行きなさい。あなたの信仰があなたを救ったのです。」"
      }
    },
    {
      "id": "7",
      ...
      "summary": "義人ぶるファリサイ派と、胸を叩いて憐れみを乞う取税人のたとえ。自分を低くする者が高く引き上げられます。",
      ...
      "memoryVerse": {
        "ref": "ルカの福音書 18:13–14",
        "text": "「ところが、取税人は遠く離れて立ち、目を天に向けようともせず、自分の胸をたたいて言った。『神様、罪人の私を憐れんでください。』あなた方に言いますが、義と認められて家に帰ったのは、あの人ではなくこの人です。」"
      }
    },
    {
      "id": "8",
      ...
      "summary": "木に登っていた取税人のかしらザアカイの家にイエスが泊まられます。失われた人を捜して救うイエスの救いがこの家に訪れます。",
      ...
      "memoryVerse": {
        "ref": "ルカの福音書 19:9–10",
        "text": "イエスは彼に言われた。「今日、救いがこの家に来ました。この人もアブラハムの子なのですから。人の子は、失われた者を捜して救うために来たのです。」"
      }
    },
    {
      "id": "9",
      ...
      "summary": "サマリアの井戸端で、イエスは渇くことのない生ける水と霊とまことによる礼拝を明かされ、町中の人々がイエスを信じます。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 4:13–14",
        "text": "「しかし、わたしが与える水を飲む者は、いつまでも決して渇くことがありません。わたしが与える水は、その人のうちで泉となり、永遠のいのちへの水が湧き出ます。」"
      }
    },
    {
      "id": "10",
      ...
      "summary": "種蒔きのたとえ。道端、岩地、茨、そして百倍の実を結ぶ良い地。みことばを聞いて受け入れる心に真の希望が実ります。",
