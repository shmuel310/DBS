...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "弟子として歩む8つの鍵",
    "titleHtml": "イエスに従うことを学ぶ",
    "lead": "新しい信仰者や、しっかりと根を下ろしたい弟子のために。弟子作り、バプテスマ、祈り、主にとどまること、愛、忍耐、聖餐、一致の8つの基本を学びます。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "根ざし、実を結ぶ",
    "body": "8つの土台を通して、生涯イエスに従い、弟子を作る弟子としての歩み方を学びました。",
    "leadSomeoneElse": "あなた自身がすでに次の人を導く準備ができています。準備ができたら誰かを誘って再スタートしましょう。",
    "nextStudy": "『イエスの命令』や『つながり、勝ち取り、育て、整え、遣わす』に進むのがおすすめです。"
  },
  "sessions": [
    {
      "id": "1",
    ...
    },
    {
      ...
      "refDisplay": "Acts 8:26&ndash;40; Matthew 28:18&ndash;20",
      "summary": "ピリポは御霊に導かれてエチオピアの宦官にイエスを伝え、宦官は信じてバプテスマを受けます。すべての民を弟子とする命令です。",
    ...
    },
    {
      ...
      "refDisplay": "Luke 11:1&ndash;13; Ephesians 6:18",
      "summary": "「主よ、祈りを教えてください。」主の祈りと、求めなさい、そうすれば与えられるという約束。天の父は求める者に聖霊を下さいます。",
      ...
      "memoryVerse": {
        "ref": "ルカの福音書 11:9",
        "text": "「わたしはあなたがたに言います。求めなさい。そうすれば与えられます。捜しなさい。そうすれば見出します。たたきなさい。そうすれば開かれます。」"
      }
    },
    {
      "id": "4",
      ...
      "refDisplay": "John 15:1&ndash;27; 2 Timothy 3:16&ndash;17",
      "summary": "イエスはまことのぶどうの木、私たちは枝です。「わたしにとどまり、わたしもその人にとどまっているなら、その人は多くの実を結びます。」",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 15:5",
        "text": "「わたしはぶどうの木、あなたがたは枝です。人がわたしにとどまり、わたしもその人にとどまっているなら、その人は多くの実を結びます。わたしを離れては、あなたがたは何もすることができないからです。」"
      }
    },
    {
      "id": "5",
      ...
      "refDisplay": "Luke 10:25&ndash;37; 1 John 3:16&ndash;18",
      "summary": "善いサマリア人のたとえ。隣人となって傷ついた人を愛すること。言葉や口先だけでなく、行いと真実をもって愛し合いましょう。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの手紙第一 3:18",
        "text": "子どもたちよ。私たちは、ことばや口先だけで愛するのではなく、行いと真実をもって愛し合いましょう。"
      }
    },
    {
      "id": "6",
      ...
      "refDisplay": "Acts 5:12&ndash;42; 1 Peter 4:12&ndash;16",
      "summary": "使徒たちは鞭打たれながらも、御名のために辱めを受けるに値する者とされたことを喜びました。キリスト者として苦しみを受けるなら、神をあがめなさい。",
      ...
      "memoryVerse": {
        "ref": "使徒の働き 5:41",
        "text": "使徒たちは、御名のために辱めを受けるにふさわしい者とされたことを喜びながら、最高法院から出て行った。"
      }
    },
    {
      "id": "7",
      "title": "聖餐の交わり",
      "refs": [
        "コリント人への手紙第一 11:23–34",
        "使徒の働き 2:42–47"
      ],
      "refDisplay": "1 Corinthians 11:23&ndash;34; Acts 2:42&ndash;47",
      "summary": "主の晩餐の制定。「これはあなたがたのための、わたしのからだです。」初代教会は使徒の教えを守り、パンを裂き、祈りに専念しました。",
      ...
      "memoryVerse": {
        "ref": "コリント人への手紙第一 11:26",
        "text": "ですから、あなたがたは、このパンを食べ、杯を飲むたびに、主が来られるまで主の死を告げ知らせるのです。"
      }
    },
    {
      "id": "8",
      ...
      "refDisplay": "Acts 2:36&ndash;47; John 17:20&ndash;21",
      "summary": "心を一つにして神を賛美し、民全体の好意を得た初代教会。イエスは、彼らが一つとなることによって世が信じるよう祈られました。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 17:21",
        "text": "「父よ、あなたがわたしのうちにおられ、わたしがあなたのうちにいるように、すべての人を一つにしてください。彼らもわたしたちのうちにいるようにしてください。あなたがわたしを遣わされたことを、世が信じるようになるためです。」"
      }
    }
  ]
};
