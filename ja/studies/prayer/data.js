...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "天の父との親しい対話",
    "titleHtml": "私たちに祈りを教えてください",
    "lead": "祈りに関する聖書の10の箇所を深く学びます。主の祈りからゲツセマネの園の祈りまで、恵みの御座に大胆に近づき、神との生きた対話を深めます。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "絶えざる祈り",
    "body": "10回の祈りの旅を通して、天の父との親しい交わりへと招かれました。主は叫びに耳を傾け、時にかなった助けを与えてくださいます。",
    "leadSomeoneElse": "あなた自身がすでに次の人を導く準備ができています。準備ができたら誰かを誘って再スタートしましょう。",
    "nextStudy": "『神の国』や『山上の垂訓』に進むのがおすすめです。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 6:9–13",
        "text": "「ですから、あなたがたはこう祈りなさい。『天におられる私たちの父よ、御名があがめられますように。御国が来ますように。みこころが天で行われるように、地でも行われますように。私たちの日ごとの糧を、今日もお与えください。私たちの負い目をお赦しください。私たちも、私たちに負い目のある人たちを赦しました。私たちを試みに会わせないで、悪からお救いください。国と力と栄光は、とこしえにあなたのものだからです。アーメン。』」"
      }
    },
    {
      "id": "2",
      ...
      "summary": "不正な裁判官とやもめのたとえ。落胆せずに絶えず祈るべきことを教えられます。神は選民の叫びに速やかに答えてくださいます。",
      ...
      "memoryVerse": {
        "ref": "ルカの福音書 18:1",
        "text": "いつでも祈るべきであり、失望してはならないことを教えるために、イエスは彼らにたとえを話された。"
      }
    },
    {
      "id": "3",
      ...
      "summary": "牢に捕らえられたペテロのために教会は熱心に祈りました。御使いが現れて鎖が解け、鉄の門が開き、ペテロは奇跡的に救い出されます。",
      ...
      "memoryVerse": {
        "ref": "使徒の働き 12:5",
        "text": "こうしてペテロは牢に閉じ込められていた。教会は彼のために、神に熱心に祈り続けていた。"
      }
    },
    {
      "id": "4",
      ...
      "summary": "何も思い煩わないで感謝をもって祈りなさい。人知を超える神の平安が、心と思いをキリスト・イエスにあって守ってくれます。",
    ...
    },
    {
      ...
      "summary": "パウロはひざまずいて祈ります。御霊によって力づけられ、キリストの愛の広さ、長さ、高さ、深さを知るようにという豊かな祈りです。",
      ...
      "memoryVerse": {
        "ref": "エペソ人への手紙 3:20–21",
        "text": "どうか、私たちのうちに働く御力によって、私たちが願うところ、思うところのすべてをはるかに超えて行うことができる方に、教会において、またキリスト・イエスにあって、栄光が、世々限りなく、とこしえにありますように。アーメン。"
      }
    },
    {
      "id": "6",
      ...
      "summary": "ゲツセマネの園での激しい苦痛の祈り。「わが父よ、できることなら、この杯をわたしから過ぎ去らせてください。しかしみこころのままに。」",
      "lookUpPrayer": "Pray about what came up in Look Back, then ask the Holy Spirit to help you understand what you&rsquo;re about to read.",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 26:39",
        "text": "それからイエスは少し進んで行き、ひれ伏して祈られた。「わが父よ、できることなら、この杯をわたしから過ぎ去らせてください。しかし、わたしの願いどおりではなく、みこころのままになさってください。」"
      }
    },
    {
      "id": "7",
      ...
      "summary": "御霊も私たちの弱さを助けてくださいます。私たちはどのように祈るべきか知りませんが、御霊ご自身が言葉に尽くせないうめきをもって執り成してくださいます。",
      "lookUpPrayer": "Bring what you just shared to God, then ask the Holy Spirit to reveal something in this passage you might otherwise miss.",
      ...
      "memoryVerse": {
        "ref": "ローマ人への手紙 8:26",
        "text": "同じように、御霊も弱い私たちを助けてくださいます。私たちは、どのように祈ったらよいかわからないのですが、御霊ご自身が、言葉に表せないうめきをもって、私たちのために執り成してくださるのです。"
      }
    },
    {
      "id": "8",
      ...
      "summary": "脅迫を受けた弟子たちが集まり大胆な宣教を祈り求めます。祈り終えると場所が揺れ動き、一同は聖霊に満たされ大胆に神のことばを語り出しました。",
      "lookUpPrayer": "Pray for each other about whatever came up in Look Back, then invite the Holy Spirit to open your eyes as you read.",
      ...
      "memoryVerse": {
        "ref": "使徒の働き 4:31",
        "text": "彼らが祈り終えると、集まっていた場所が揺れ動き、一同は聖霊に満たされ、神のことばを大胆に語り出した。"
      }
    },
    {
      "id": "9",
      ...
      "summary": "子どもが与えられず苦しむハンナは、涙を流して主に心の内を注ぎ出しました。エリの祝福を受け、神は彼女を顧みられサムエルが生まれます。",
      "lookUpPrayer": "Pray about what&rsquo;s come up so far, then ask the Holy Spirit to help you see this passage clearly.",
      ...
      "memoryVerse": {
        "ref": "サムエル記第一 1:27",
        "text": "「この子のために私は祈りました。主は私が願ったとおりに、求めたものを私に与えてくださいました。」"
      }
    },
    {
      "id": "10",
      ...
      "summary": "目を覚まして感謝をもって、たゆみなく祈り続けなさい。また御ことばの門が開かれるよう伝道者のためにも祈りを求めます。",
      ...
      "memoryVerse": {
        "ref": "コロサイ人への手紙 4:2",
        "text": "目を覚まして感謝をささげながら、たゆみなく祈りなさい。"
      }
    }
  ]
};
