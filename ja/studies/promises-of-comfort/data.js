...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "苦難の中の休息と希望",
    "titleHtml": "10の慰めの約束",
    "lead": "疲れた魂に力を与える、聖書の10の慰めの約束。不安、孤独、弱さ、喪失の中にあっても、神の真実なみことばは私たちの砦であり、確かな助けです。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "豊かな慰め",
    "body": "10の約束を通して、神の変わらない愛と真実を受け取りました。神の平安は人知をはるかに超えて私たちを守ります。",
    "leadSomeoneElse": "あなた自身がすでに次の人を導く準備ができています。準備ができたら誰かを誘って再スタートしましょう。",
    "nextStudy": "『私たちに祈りを教えてください』や『神の国』に進むのがおすすめです。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 14:27",
        "text": "「わたしはあなたがたに平安を残します。わたしの平安を与えます。わたしは、世が与えるのとは違って、あなたがたに与えます。心を騒がせてはなりません。おびえてはなりません。」"
      }
    },
    {
      "id": "2",
      ...
      "summary": "主よ、あなたは私を探り、私を知っておられます。主の御霊から離れてどこへ行けましょう。母の胎で組み立てられた私の造りは恐ろしく奇しいものです。",
      ...
      "promiseVerse": {
        "ref": "Hebrews 13:5",
        "text": "&hellip;because God has said, &ldquo;Never will I leave you; never will I forsake you.&rdquo;"
      },
      "memoryVerse": {
        "ref": "ヘブル人への手紙 13:5",
        "text": "金銭を愛する生活をしてはいけません。いま持っているもので満足しなさい。主ご自身がこう言われたのです。「わたしは決してあなたを見放さず、あなたを見捨てない。」"
      }
    },
    {
      "id": "3",
      ...
      "summary": "5つのパンと2匹の魚の奇跡。人間に不可能な状況で、主は豊かに養われ、12のかごが余ります。主の満ちあふれる恵みの約束です。",
      ...
      "memoryVerse": {
        "ref": "ピリピ人への手紙 4:19",
        "text": "また、私の神は、キリスト・イエスにあるご自身の栄光の富をもって、あなたがたの必要をすべて満たしてくださいます。"
      }
    },
    {
      "id": "4",
      ...
      "summary": "罪を告白した者の幸い。黙っていたときは骨が朽ち果てましたが、主に向かって罪を言い表したとき赦され、救いの歓声で囲まれました。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの手紙第一 1:9",
        "text": "もし私たちが自分の罪を告白するなら、神は真実で正しい方ですから、その罪を赦し、私たちをあらゆる不義からきよめてくださいます。"
      }
    },
    {
      "id": "5",
      ...
      "summary": "失望してエマオへ向かう二人の弟子に、復活の主が寄り添い聖書を解き明かされます。パンを裂かれたとき目が開かれ、心は燃え上がりました。",
      ...
      "promiseVerse": {
        "ref": "Proverbs 3:5&ndash;6",
        "text": "Trust in the LORD with all your heart and lean not on your own understanding; in all your ways submit to him, and he will make your paths straight."
      },
      "memoryVerse": {
        "ref": "箴言 3:5–6",
        "text": "心を尽くして主に拠り頼め。自分の悟りにたよるな。あなたの行く道すべてにおいて、主を認めよ。そうすれば、主はあなたの道をまっすぐにされる。"
      }
    },
    {
      "id": "6",
      ...
      "summary": "苦しんでいる人は祈りなさい。喜んでいる人は賛美しなさい。信仰による祈りは病む人を救います。義人の祈りは大いに力を発揮します。",
      "lookUpPrayer": "Pray about what came up in Look Back, then ask the Holy Spirit to help you understand what you&rsquo;re about to read.",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 15:7",
        "text": "「あなたがたがわたしにとどまり、わたしのことばがあなたがたにとどまっているなら、何でも欲しいものを求めなさい。そうすれば、それはかなえられます。」"
      }
    },
    {
      "id": "7",
      ...
      "summary": "心を騒がせてはなりません。神を信じ、わたしを信じなさい。父の家には住まいがたくさんあります。場所を用意したら迎えに来ます。",
      "lookUpPrayer": "Bring what you just shared to God, then ask the Holy Spirit to reveal something in this passage you might otherwise miss.",
    ...
    },
    {
      ...
      "summary": "肉体に与えられた一つのとげ。パウロの3度の祈りに対し、主は言われました。「わたしの恵みはあなたに十分である。力は弱さのうちに完全に現れる。」",
      "lookUpPrayer": "Pray for each other about whatever came up in Look Back, then invite the Holy Spirit to open your eyes as you read.",
      ...
      "memoryVerse": {
        "ref": "ピリピ人への手紙 4:13",
        "text": "私は、私を強くしてくださる方によって、どんなことでもできるのです。"
      }
    },
    {
      "id": "9",
      ...
      "summary": "月や星を見上げるとき、人とは何者なのでしょう、これを心に留められるとは。神は人に栄光と誉れの冠を授け、万物を治めさせられます。",
    ...
    },
    {
      ...
      "summary": "信仰によって義と認められた私たちは、神との平和を持っています。患難さえも誇りとし、患難は忍耐を、忍耐は練られた品性を、品性は希望を生みます。",
      "lookUpPrayer": "Pray about everything this course has stirred up in you, then ask the Holy Spirit to help you see where he&rsquo;s been quietly at work in your own story too.",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 16:24",
        "text": "「今までは、あなたがたはわたしの名によっては何も求めたことがありませんでした。求めなさい。そうすれば受けます。あなたがたの喜びが満ちあふれるようになるためです。」"
      }
    }
  ]
};
