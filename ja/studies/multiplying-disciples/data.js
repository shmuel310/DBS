/* Auto-generated localized study data */
window.STUDY = {
  "id": "multiplying-disciples",
  "title": "つながり、勝ち取り、育て、整え、遣わす",
  "sessionNoun": "週",
  "sessionsLabel": "17週間",
  "footerAttribution": "Dann Spader による『Like Jesus』の弟子作り原則に基づく",
  "welcomeCopy": {
    "tagline": "イエスの3年半の弟子作りの歩み",
    "titleHtml": "つながり<br>勝ち取り<br>育て<br>整え<br>遣わす",
    "lead": "イエスの約3年半の公生涯をたどる17週間。普通の漁師と出会い、勝ち取り、育て、整え、世界を変革する弟子として遣わすまでの歩みを見つめます。"
  },
  "methodCopy": {
    "lead": "すべてのセッションで同じ順序で同じ <strong style=\"color:var(--ink-900);font-weight:600;\">3つのステップ</strong> を踏みます。所要時間は全体で <strong style=\"color:var(--ink-900);font-weight:600;\">約60〜90分</strong> です。",
    "lookBackBlurb": "先週の歩みを振り返り、神の恵み、感謝なこと、課題、実践の結果を分かち合います。",
    "lookUpBlurb": "聖書を声に出して読み、自分の言葉で物語を言い直し、核心の問いを通して深く掘り下げます。",
    "lookForwardBlurb": "発見したことを実際の生活への応答へと変え、具体的な目標を立てて互いのために祈り合います。"
  },
  "finishCopy": {
    "heading": "弟子の継承",
    "body": "17週間にわたりイエスの生涯全体をたどりました。すべての民を弟子とするようにとの主の召命こそ、私たちのこれからの歩みです。",
    "leadSomeoneElse": "あなた自身がすでに次の人を導く準備ができています。準備ができたら誰かを誘って再スタートしましょう。",
    "nextStudy": "『壁を越えて』や『イエスの命令』に進むのがおすすめです。"
  },
  "timeline": {
    "href": "timeline.html",
    "title": "タイムライン",
    "meta": "イエスの約3年半の公生涯における17週間の時間的配置と背景解説"
  },
  "preReading": {
    "intro": [
      "このコースはイエスの生涯を年代順にたどり、特にイエスがどのように弟子たちを育てられたかに焦点を当てています。17週間あってもすべてを網羅することはできません。物語は、イエスが30歳になり、バプテスマと荒野の試みを受けた直後、すなわち公生涯の始まりからスタートします。",
      "この事前の読書は、それ以前の30年間をカバーします。幼少時代、そしてバプテスマのヨハネが道を整える場面です。",
      "イエスは誰かを弟子として招く前に、ご自身が父なる神によって整えられ、後に弟子たちに求める姿そのものとなられました。誰かを形作る前に、まずご自身が形作られたという事実は、学びを始めるにあたり深く心に留める価値があります。"
    ],
    "days": [
      {
        "ref": "ヨハネの福音書 1:1–18",
        "desc": "プロローグ：「初めにことばがあった」。物語が始まる前のイエスの本質。"
      },
      {
        "ref": "ルカの福音書 2:22–39",
        "desc": "生後40日で宮に連れて来られたイエス。シメオンとアンナが救い主を認めます。"
      },
      {
        "ref": "ルカの福音書 2:41–52",
        "desc": "12歳のイエスが神殿で語り合い、知恵と背たけが伸びてゆく成長の記録。"
      },
      {
        "ref": "マタイの福音書 3:1–12",
        "desc": "道を整えるバプテスマのヨハネ：宣教、悔い改めの勧め、来たるべき方への警告。"
      },
      {
        "ref": "マタイの福音書 3:13–4:11",
        "desc": "イエスのバプテスマと試み。弟子を招く前に、まず御子として承認され試みを受けられました。"
      }
    ]
  },
  "sessions": [
    {
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 1:39",
        "text": "イエスは彼らに言われた。「来なさい。そうすれば分かります。」そこで彼らはついて行って、イエスの泊まっておられる所を知り、その日はイエスのところに泊まった。十時ごろのことであった。"
      },
      "betweenSessions": {
        "days": [
          {
            "ref": "John 2:1&ndash;12",
            "desc": "Water to wine at Cana; on to Capernaum."
          },
          {
            "ref": "John 2:13&ndash;22",
            "desc": "Clearing the temple."
          }
        ]
      }
    },
    {
      ...
      "summary": "夜イエスを訪ねたニコデモ。人は新しく生まれなければ神の国を見ることはできないと教え、神がひとり子を与えるほどに世を愛されたと語られます。",
      ...
      "betweenSessions": {
        "days": [
          {
            "ref": "John 3:22&ndash;36",
            "desc": "John the Baptist&rsquo;s testimony about Jesus."
          }
        ]
      }
    },
    {
      ...
      "summary": "サマリアの井戸端で女性に声をかけ、永遠の渇きをいやす生ける水を授けられます。彼女の証しによって町中の人々がイエスを信じました。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 4:39",
        "text": "さて、その町のサマリア人のうち多くの者が、「あの人は、私がしたことすべてを私に言った」と証言した女のことばによって、イエスを信じた。"
      },
      "betweenSessions": {
        "days": [
          {
            "ref": "John 4:43&ndash;54",
            "desc": "Welcomed in Galilee; heals an official&rsquo;s son."
          },
          {
            "ref": "Luke 4:16&ndash;31",
            "desc": "Rejected at Nazareth."
          },
          {
            "ref": "Matthew 4:12&ndash;17",
            "desc": "Settles in Capernaum; ministry begins."
          }
        ]
      }
    },
    {
      ...
      "summary": "夜通し働いても何も捕れなかったペテロが、みことばに従って網を下ろすと魚が破れんばかりに捕れます。イエスは彼を「人間をとる漁師」に招きます。",
      ...
      "memoryVerse": {
        "ref": "ルカの福音書 5:10–11",
        "text": "イエスはシモンに言われた。「恐れることはない。今から後、あなたは人間をとるようになるのだ。」彼らは舟を陸に着けると、すべてを捨ててイエスに従った。"
      },
      "betweenSessions": {
        "days": [
          {
            "ref": "Mark 1:21&ndash;34",
            "desc": "An unclean spirit; healings at Capernaum."
          },
          {
            "ref": "Mark 1:35&ndash;45",
            "desc": "A preaching tour of Galilee; cleansing a leper."
          },
          {
            "ref": "Luke 5:17&ndash;26",
            "desc": "The paralysed man lowered through the roof."
          }
        ]
      }
    },
    {
      ...
      "summary": "取税所に座るマタイを招き、罪人たちと食卓を共にされます。「医者を必要とするのは病人です。わたしが来たのは罪人を招くためです。」",
      "lookUpPrayer": "Pray about what came up in Look Back, then ask the Holy Spirit to help you understand what you&rsquo;re about to read.",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 9:13",
        "text": "「『わたしが喜びとするのは真実の愛。いけにえではない』とはどういう意味か、行って学びなさい。わたしが来たのは、正しい人を招くためではなく、罪人を招くためです。」"
      },
      "betweenSessions": {
        "days": [
          {
            "ref": "John 5:1&ndash;47",
            "desc": "Healing at the Pool of Bethesda."
          },
          {
            "ref": "Mark 2:18&ndash;3:6",
            "desc": "Fasting, the Sabbath, the man with the shrivelled hand."
          },
          {
            "ref": "Matthew 12:15&ndash;21",
            "desc": "The promised Servant."
          }
        ]
      }
    },
    {
      ...
      "summary": "徹夜の祈りの後、山で十二人を任命されます。みそばに置き、宣教と悪霊追放の権威を授けて遣わすためです。",
      "lookUpPrayer": "Bring what you just shared to God, then ask the Holy Spirit to reveal something in this passage you might otherwise miss.",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 3:14",
        "text": "そこでイエスは十二人を任命し、彼らをご自分のそばに置くことにされた。また、彼らを遣わして宣教をさせ、"
      }
    },
    {
      "id": "7",
      ...
      "summary": "山上で神の国の民の幸いを教えられます。心の貧しい者、悲しむ者、柔和な者、義に飢え渇く者、あわれみ深い者、心の清い者、平和をつくる者、義のために迫害される者。",
      "lookUpPrayer": "Pray for each other about whatever came up in Look Back, then invite the Holy Spirit to open your eyes as you read.",
      ...
      "betweenSessions": {
        "days": [
          {
            "ref": "Matthew 5:13&ndash;7:29",
            "desc": "Finishing the Sermon on the Mount."
          },
          {
            "ref": "Matthew 8:5&ndash;13; Luke 7:11&ndash;17",
            "desc": "The centurion&rsquo;s faith; the widow&rsquo;s son at Nain."
          },
          {
            "ref": "Matthew 8:23&ndash;34",
            "desc": "Calming the storm; the Gerasene demoniac."
          }
        ]
      }
    },
    {
      ...
      "summary": "羊飼いのいない羊のように弱り果てた群衆を見て深く憐れまれるイエス。収穫の主に祈るよう促し、十二人を二人ずつ宣教に派遣されます。",
      "lookUpPrayer": "Pray about what came up in Look Back, then ask the Holy Spirit to help you understand what you&rsquo;re about to read.",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 10:7–8",
        "text": "「行って、『天の御国が近づいた』と宣べ伝えなさい。病人を癒やし、死人を生き返らせ、ツァラアトに冒された者をきよめ、悪霊を追い出しなさい。あなたがたはただで受けたのですから、ただで与えなさい。」"
      },
      "betweenSessions": {
        "days": [
          {
            "ref": "Matthew 14:13&ndash;33",
            "desc": "Feeding the 5,000; walking on water."
          },
          {
            "ref": "John 6:22&ndash;71",
            "desc": "The Bread of Life; many disciples turn back."
          },
          {
            "ref": "Matthew 15:21&ndash;39",
            "desc": "A Gentile mother&rsquo;s faith; feeding the 4,000."
          }
        ]
      }
    },
    {
      ...
      "summary": "ピリポ・カイザリヤでペテロが「あなたは生ける神の御子キリストです」と告白します。イエスはこの岩の上に教会を建てると宣言されます。",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 16:16–17",
        "text": "シモン・ペテロが答えた。「あなたは生ける神の御子キリストです。」イエスは彼に答えられた。「バルヨナ・シモン、あなたは幸いです。このことをあなたに明かしたのは肉と血ではなく、天におられるわたしの父です。」"
      },
      "betweenSessions": {
        "days": [
          {
            "ref": "Matthew 16:21&ndash;28",
            "desc": "The first death prediction; the cost of following."
          }
        ]
      }
    },
    {
      ...
      "summary": "祈るために山に登られたイエスの姿が光り輝き、モーセとエリヤが現れます。雲から「これはわたしの愛する子、これに聞け」と声がします。",
      "lookUpPrayer": "Pray about what came up in Look Back, then ask the Holy Spirit to help you understand what you&rsquo;re about to read.",
      ...
      "memoryVerse": {
        "ref": "ルカの福音書 9:35",
        "text": "すると雲の中から声がした。「これはわたしの愛する子、選ばれた者。彼の言うことを聞きなさい。」"
      },
      "betweenSessions": {
        "days": [
          {
            "ref": "Matthew 17:9&ndash;13",
            "desc": "Coming down the mountain; questions about Elijah."
          }
        ]
      }
    },
    {
      ...
      "summary": "信仰の薄さのゆえに悪霊を追い出せなかった弟子たち。イエスはからし種一粒ほどの信仰があれば不可能なことは何もないと教えられます。",
      "lookUpPrayer": "Bring what you just shared to God, then ask the Holy Spirit to reveal something in this passage you might otherwise miss.",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 17:20",
        "text": "イエスは言われた。「あなたがたの信仰が薄いからです。まことに、あなたがたに言います。もし、からし種ほどの信仰があるなら、この山に向かって『ここからあそこに移れ』と言えば、移ります。あなたがたにできないことは何もないのです。」"
      },
      "betweenSessions": {
        "days": [
          {
            "ref": "Matthew 17:22&ndash;27",
            "desc": "The second death prediction; the temple tax."
          }
        ]
      }
    },
    {
      ...
      "summary": "天の国で誰が一番偉いかを議論する弟子たち。イエスは幼子を真ん中に立たせ、幼子のようにならなければ天の国に入ることはできないと示されます。",
      "lookUpPrayer": "Pray about what came up in Look Back, then ask the Holy Spirit to help you understand what you&rsquo;re about to read.",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 18:4",
        "text": "「ですから、だれでもこの子どものように自分を低くする人が、天の御国で一番偉いのです。」"
      },
      "betweenSessions": {
        "days": [
          {
            "ref": "Matthew 18:6&ndash;20",
            "desc": "Warnings against causing others to stumble; how to handle conflict."
          }
        ]
      }
    },
    {
      ...
      "summary": "7回赦せば十分かというペテロに、7回を70倍するまで赦しなさいと教えられます。莫大な負債を赦されたしもべのたとえです。",
      "lookUpPrayer": "Pray for each other about whatever came up in Look Back, then invite the Holy Spirit to open your eyes as you read.",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 18:32–33",
        "text": "「そこで主人は彼を呼びつけて言った。『悪いしもべだ。おまえが頼んだからこそ、あの借金を全部免除してやったのだ。わたしがおまえを憐れんでやったように、おまえも仲間を憐れんでやるべきではなかったか。』」"
      },
      "betweenSessions": {
        "days": [
          {
            "ref": "Luke 9:51&ndash;62",
            "desc": "The journey to Jerusalem begins; the cost of following."
          },
          {
            "ref": "John 8:1&ndash;20",
            "desc": "The woman caught in adultery; &ldquo;I am the light of the world.&rdquo;"
          },
          {
            "ref": "John 9:1&ndash;41",
            "desc": "Healing the man born blind."
          }
        ]
      }
    },
    {
      ...
      "summary": "七十二人を二人ずつあらゆる町に派遣されます。彼らは悪霊が服従したと喜び帰りますが、イエスは名が天に書き記されていることを喜びなさいと諭されます。",
      "lookUpPrayer": "Pray about what came up in Look Back, then ask the Holy Spirit to help you understand what you&rsquo;re about to read.",
      ...
      "memoryVerse": {
        "ref": "ルカの福音書 10:2",
        "text": "イエスは彼らに言われた。「収穫は多いが、働き手が少ない。だから、収穫の主に、ご自分の収穫のために働き手を送ってくださるように祈りなさい。」"
      },
      "betweenSessions": {
        "days": [
          {
            "ref": "Luke 10:25&ndash;37; 10:38&ndash;42",
            "desc": "The Good Samaritan; Mary and Martha, both about how a disciple actually behaves."
          },
          {
            "ref": "Luke 15:1&ndash;32",
            "desc": "The lost sheep, the lost coin, and the Prodigal Son."
          },
          {
            "ref": "John 11:1&ndash;44",
            "desc": "Lazarus, raised."
          },
          {
            "ref": "Luke 19:1&ndash;10; Matthew 19:16&ndash;30",
            "desc": "Zacchaeus, who responded; the rich young ruler, who didn&rsquo;t."
          },
          {
            "ref": "Matthew 22:34&ndash;40; Matthew 21:1&ndash;11",
            "desc": "The Greatest Commandment; the Triumphal Entry."
          }
        ],
    ...
    },
    {
      ...
      "summary": "最後の晩餐の席で、イエスは手ぬぐいを腰にまとい弟子たちの足を一人ずつ洗われました。仕え合い、愛し合う模範を示されたのです。",
      "lookUpPrayer": "Pray about what&rsquo;s come up so far, then ask the Holy Spirit to help you see this passage clearly.",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 13:14–15",
        "text": "「主であり師であるわたしが、あなたがたの足を洗ったのなら、あなたがたも互いに足を洗い合うべきです。わたしがあなたがたにしたとおりに、あなたがたもするように、わたしは手本を示したのです。」"
      },
      "betweenSessions": {
        "days": [
          {
            "ref": "John 14:1&ndash;31",
            "desc": "The farewell discourse, part one."
          },
          {
            "ref": "John 15:1&ndash;16:33",
            "desc": "The vine and branches; &ldquo;I have called you friends.&rdquo;"
          },
          {
            "ref": "John 17:1&ndash;26; Matthew 26:36&ndash;46",
            "desc": "The high priestly prayer; Gethsemane."
          },
          {
            "ref": "Matthew 26:47&ndash;27:56",
            "desc": "Arrest, trial, crucifixion, and Jesus&rsquo; death."
          },
          {
            "ref": "Luke 24:13&ndash;35; John 20:24&ndash;29",
            "desc": "The road to Emmaus; Thomas."
          }
        ],
    ...
    },
    {
      ...
      "summary": "湖畔で夜通し収穫のなかった弟子たちに朝食を用意された復活のイエス。ペテロに「わたしを愛するか」と三度問い、「わたしの羊を飼いなさい」と回復されます。",
      "lookUpPrayer": "Pray about what came up in Look Back, then ask the Holy Spirit to help you understand what you&rsquo;re about to read.",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 21:17",
        "text": "イエスは三度目に言われた。「ヨハネの子シモン、わたしを愛しているか。」ペテロは、イエスが三度「わたしを愛しているか」と言われたので心を痛めて言った。「主よ、あなたはいっさいのことをご存じです。私があなたを愛していることは、ご存じです。」イエスは言われた。「わたしの羊を飼いなさい。」"
      }
    },
    {
      "id": "17",
      ...
      "summary": "ガリラヤの山で与えられた大宣教命令。「天と地の一切の権威がわたしに与えられています。ですから行って、あらゆる国の人々を弟子としなさい。」世の終わりまで共にいます。",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 28:19–20",
        "text": "「ですから、あなたがたは行って、あらゆる国の人々を弟子としなさい。父、子、聖霊の名においてバプテスマを授け、わたしがあなたがたに命じておいたすべてのことを守るように、彼らを教えなさい。見よ。わたしは、世の終わりまで、いつもあなたがたとともにいます。」"
      }
    }
  ]
};
