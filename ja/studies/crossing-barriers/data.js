...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "キリストにある和解と受け入れ",
    "titleHtml": "壁を越えて",
    "lead": "聖書の10の箇所をたどる旅。福音がいかに民族、社会的立場、性別、道徳の壁を乗り越え、キリストにあって隔ての壁を打ち壊し、真の和解をもたらすかを見つめます。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "隔ての壁を崩して",
    "body": "10の聖書箇所を通して、十字架による和解の力を見つめました。キリストは私たちを和解の使節として遣わされます。",
    "leadSomeoneElse": "あなた自身がすでに次の人を導く準備ができています。準備ができたら誰かを誘って再スタートしましょう。",
    "nextStudy": "『10の慰めの約束』や『私たちに祈りを教えてください』に進むのがおすすめです。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 4:9",
        "text": "サマリアの女は言った。「あなたはユダヤ人でありながら、どうしてサマリアの女の私に、水を飲ませてほしいとおっしゃるのですか。」ユダヤ人はサマリア人と付き合いをしなかったからである。"
      }
    },
    {
      "id": "2",
      ...
      "summary": "神はキリストによって私たちをご自分と和解させ、和解の務めを委ねられました。キリストにある者はだれをも肉に従って知りません。",
      ...
      "memoryVerse": {
        "ref": "コリント人への手紙第二 5:18",
        "text": "これらのことはすべて、神から出ています。神は、キリストによって私たちをご自分と和解させ、また、和解の務めを私たちに与えてくださいました。"
      }
    },
    {
      "id": "3",
      ...
      "summary": "罪深い女が涙でイエスの足をぬらし香油を塗ります。多く赦された者は多く愛するという主のことばが、偏見に満ちた心を打ち砕きます。",
      ...
      "memoryVerse": {
        "ref": "ルカの福音書 7:47",
        "text": "「ですから、わたしはあなたに言いますが、この人の多くの罪は赦されています。彼女が多く愛したからです。」"
      }
    },
    {
      "id": "4",
      ...
      "summary": "キリストは十字架によって敵意を滅ぼし、ユダヤ人と異邦人を隔てていた壁を打ち壊し、一つの新しい人に造り変えて平和をもたらされました。",
      ...
      "memoryVerse": {
        "ref": "エペソ人への手紙 2:14",
        "text": "実に、キリストこそ私たちの平和です。キリストは二つのものを一つにし、ご自分の肉において、隔ての壁である敵意を打ち砕き、"
      }
    },
    {
      "id": "5",
      "title": "わたしもあなたを罪に定めない",
      "refs": [
        "ヨハネの福音書 7:53–8:11"
      ],
      "summary": "姦淫の現場で捕らえられた女性。「罪のない者がまず石を投げなさい。」誰もいなくなった後、イエスは「わたしもあなたを罪に定めない。行きなさい。これからは罪を犯してはならない」と告げられます。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 8:11",
        "text": "彼女は言った。「主よ、だれもいません。」イエスは言われた。「わたしもあなたを罪に定めない。行きなさい。これからは、決して罪を犯してはならない。」"
      }
    },
    {
      "id": "6",
      ...
      "summary": "パウロは逃亡奴隷オネシモのために主人ピレモンに執り成し、もはや奴隷としてではなく、愛する信仰の兄弟として迎えるよう願います。",
      ...
      "memoryVerse": {
        "ref": "ピレモンへの手紙 1:16",
        "text": "もはや奴隷としてではなく、奴隷以上の者、すなわち愛する兄弟としてです。私にとってそうであるなら、あなたにとっては、肉においても主にあっても、なおのことそうではありませんか。"
      }
    },
    {
      "id": "7",
      ...
      "summary": "人を差別してはならない。富める者を優遇し貧しい者を軽んじるのは罪です。「隣人を自分のように愛しなさい」という最高の律法を守りましょう。",
      ...
      "memoryVerse": {
        "ref": "ヤコブの手紙 2:8–9",
        "text": "もしあなたがたが、聖書に従って、「あなたの隣人を自分自身のように愛しなさい」という最高の律法を守るなら、それは立派なことです。しかし、人を差別するなら、あなたがたは罪を犯していることになり、律法によって違反者と定められます。"
      }
    },
    {
      "id": "8",
      ...
      "summary": "神は愛です。愛のうちにとどまる人は神のうちにとどまっています。愛には恐れがありません。全き愛は恐れを締め出します。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの手紙第一 4:18",
        "text": "愛には恐れがありません。全き愛は恐れを締め出します。恐れには罰が伴い、恐れる者は、愛において全うされていないのです。"
      }
    },
    {
      "id": "9",
      ...
      "summary": "神は人を偏り見ず、賄賂を取らず、みなしごとやもめのために正義を行い、寄留者を愛されます。あなた方も寄留者を愛しなさい。",
      ...
      "memoryVerse": {
        "ref": "申命記 10:19",
        "text": "あなたがたは寄留者を愛しなさい。あなたがたもエジプトの地で寄留者であったからである。"
      }
    },
    {
      "id": "10",
      "title": "あらゆる国民、部族、民族、言語",
      "refs": [
        "ヨハネの黙示録 7:9–12"
      ],
      "summary": "あらゆる国民、部族、民族、言語から、誰も数え切れないほどの大群衆が白い衣をまとい、御座と小羊の前で賛美の声をあげます。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの黙示録 7:9",
        "text": "その後、私は見た。見よ、あらゆる国民、部族、民族、言語から、だれも数え切れないほどの大群衆が、白い衣をまとい、手になつめやしの枝を持って、御座の前と小羊の前に立っていた。"
      }
    }
  ]
};
