...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "創世記から福音書まで",
    "titleHtml": "キリスト<br>者の<br>基礎",
    "lead": "天地創造から十字架、そして復活へ。聖書の壮大な物語を10回でたどります。毎回少しずつ聖書を読み、神が語り続けてこられたストーリーを発見し、グループまたは1対1でともに応答しましょう。"
  },
  "methodCopy": {
    "lead": "すべてのセッションで同じ順序で同じ <strong style=\"color:var(--ink-900);font-weight:600;\">3つのステップ</strong> を踏みます。2人でも小グループでも同様です。所要時間は全体で <strong style=\"color:var(--ink-900);font-weight:600;\">約90分</strong> を見込んでいますが、大まかな目安であり、少し急いで60分で終えても十分に機能します。",
    "lookBackBlurb": "再び心をつなぎ合わせる時間です。今週どのように神を体験したか、感謝なこと、困難だったこと、そして前回の学びが生活の中でどのように実を結んだかを分かち合います。",
    "lookUpBlurb": "聖書箇所を声に出して読み、自分の言葉で言い直して、話の全容を把握したか確かめます。その上でいくつかの質問を通して深く掘り下げます。",
    "lookForwardBlurb": "発見したことを実際の生活への応答へと変えます。実践すべき行動、信頼すべき約束、見習うべき模範、従うべき命令などです。そして「いつまでに、何を、何のために行うか」という具体的な目標を立て、誰に分かち合うかを決め、最後に互いのために祈ります。",
    "respondItems": [
      "改めるべき行動は？",
      "握りしめるべき約束は？",
      "見習うべき模範は？",
    ...
    "lookBackDefaults": [
      "今週どのように神を体験しましたか？",
      "感謝なことは何ですか？",
      "前回の集まり以降、何か悩んだり困ったりしたことはありますか？",
      "前回の学びをどのように生活に適用できましたか？",
      "前回の学びを誰かに分かち合うことはできましたか？"
    ]
  },
  "finishCopy": {
    "heading": "新しいいのち",
    "body": "エデンの園から空の墓まで全10回。神がどのような方か、人間がどこで道を誤ったか、そして神がそれに対して何をしてくださったかという1つの物語をたどってきました。振り返り、見上げ、前を向くリズムを共にしてきた旅は、終わりではなく新しい始まりです。",
    "leadSomeoneElse": "このコースは特別な訓練を受けなくても進められるよう作られており、あなた自身がすでに他の人を導く準備ができています。各セッションで聖書箇所を誰かに伝えてきたなら、その人が最初の招待相手としてぴったりです。準備ができたら進捗をリセットし、その人と一緒に再スタートしましょう。",
    "nextStudy": "知らず知らずのうちに、あなた方はディスカバリー・バイブル・スタディ（DBS）を実践してきました。これは誰かと一緒に聖書を読むためのシンプルで再現可能な方法です（振り返る、見上げる、前を向く）。あらゆる聖書箇所や書巻でこのリズムを続けてみてください。『この方は誰なのか？（マルコの福音書）』は、次に進むコースとして最適です。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "memoryVerse": {
        "ref": "創世記 2:7",
        "text": "神である主は、土地のちりで人を形造り、その鼻にいのちの息を吹き込まれた。そこで人は生きものとなった。"
      }
    },
    {
      "id": "2",
      ...
      "summary": "蛇がエバとアダムを欺いて神の言葉を疑わせ、禁じられていた善悪の知識の木から食べさせます。罪、恥、責任転嫁、そして神と人との断絶が直ちに訪れます。",
      ...
      "memoryVerse": {
        "ref": "創世記 3:15",
        "text": "「わたしは敵意を、おまえと女の間に、おまえの子孫と女の子孫の間に置く。彼はおまえの頭を踏み砕き、おまえは彼のかかとにかみつく。」"
      }
    },
    {
      "id": "3",
      ...
      "summary": "人間の悪が増大し、神は人を造ったことを悔やんで地を洪水で滅ぼすことを決められます。しかし義人ノアだけは恵みを見いだし、箱舟を造って家族と動物たちを守りました。",
    ...
    },
    {
      ...
      "summary": "神はイスラエルをエジプトの奴隷の家から救い出し、シナイ山で十戒を授けられました。神を愛し、隣人を愛して生きるための神聖な契約です。",
      ...
      "memoryVerse": {
        "ref": "出エジプト記 20:2–3",
        "text": "「わたしは、あなたをエジプトの地、奴隷の家から導き出したあなたの神、主である。あなたには、わたしのほかに、ほかの神々があってはならない。」"
      }
    },
    {
      "id": "5",
      ...
      "refDisplay": "Jeremiah 31:31&ndash;34; Isaiah 59:1&ndash;2",
      "summary": "サウル王の背信の後、神はサムエルを遣わして少年ダビデに油を注がせます。人はうわべを見ますが、主は心を見られます。",
      ...
      "memoryVerse": {
        "ref": "サムエル記第一 16:7",
        "text": "しかし主はサムエルに言われた。「彼の容貌や背の高さを見てはならない。わたしは彼を退けている。人が見るようには見ないからだ。人はうわべを見るが、主は心を見る。」"
      }
    },
    {
      "id": "6",
      ...
      "refDisplay": "Isaiah 52:13&ndash;53:12; John 1:29&ndash;34",
      "summary": "預言者イザヤは苦難のしもべを預言します。彼は私たちの背きのために刺し通され、私たちの罪のために砕かれ、その打ち傷によって私たちが癒やされました。",
      ...
      "memoryVerse": {
        "ref": "イザヤ書 53:5",
        "text": "しかし彼は、私たちの背きの罪のために刺し通され、私たちの咎のために砕かれた。彼への懲らしめが私たちに平安をもたらし、その打ち傷によって、私たちは癒やされた。"
      }
    },
    {
      "id": "7",
      ...
      "summary": "ベツレヘムの飼い葉桶に生まれたイエス。野原の羊飼いたちに御使いが大いなる喜びの知らせを告げます。「今日、救い主がお生まれになりました。」",
      ...
      "memoryVerse": {
        "ref": "ルカの福音書 2:10–11",
        "text": "御使いは彼らに言った。「恐れることはありません。見なさい。私は、すべての民に与えられる大きな喜びの知らせを伝えます。今日ダビデの町で、あなたがたのために救い主がお生まれになりました。この方こそ主キリストです。」"
      }
    },
    {
      "id": "8",
      ...
      "summary": "エリコを通られるイエスは、取税人のかしらザアカイの家に泊まられます。ザアカイの人生は一変し、イエスは失われた者を捜して救うために来たと宣言されます。",
    ...
    },
    {
      ...
      "refDisplay": "Matthew 7:24&ndash;29; James 1:22",
      "summary": "イエスは侮辱され、鞭打たれ、十字架に釘付けにされます。神殿の幕が上から下まで真っ二つに裂け、百人隊長は「この人は本当に神の子だった」と証言しました。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 15:39",
        "text": "イエスの正面に立っていた百人隊長は、イエスがこのように息を引き取られたのを見て、「この人は本当に神の子だった」と言った。"
      }
    },
    {
      "id": "10",
      ...
      "summary": "週の初めの早朝、墓を訪れた女性たちは石が転がされているのを見ます。御使いはよみがえりを告げ、復活の主はすべての民を弟子とする大宣教命令を与えられます。",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 28:5–6",
        "text": "すると御使いは女たちに言った。「恐れることはありません。あなたがたが十字架につけられたイエスを捜しているのを、私は知っています。ここにはおられません。前から言っておられたように、よみがえられたのです。さあ、主が納められていた場所を見なさい。」"
      }
    }
  ]
};
