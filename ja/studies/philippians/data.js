...
window.STUDY = {
  ...
  "stepTimes": {
    "lookback": "10&ndash;15 min",
    "lookup": "25&ndash;35 min",
    "lookforward": "15&ndash;20 min"
  },
  "welcomeCopy": {
    "tagline": "ピリピ人への手紙をたどる旅",
    "titleHtml": "新しいいのち、本当の喜び",
    "lead": "獄中のパウロが記した、喜びに満ちあふれる手紙。ピリピ人への手紙をたどる6週間。状況を超えた平安、キリストにある一致、そして真のいのちの喜びを見出します。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "真の喜び",
    "body": "6週間のピリピ人への手紙の旅を通して、喜びとは状況によるのではなく、キリスト・イエスにある平安と信頼から湧き出るものであることを学びました。",
    "leadSomeoneElse": "あなた自身がすでに次の人を導く準備ができています。準備ができたら誰かを誘って再スタートしましょう。",
    "nextStudy": "『ルツ記』や『イエスに従うことを学ぶ』に進むのがおすすめです。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "memoryVerse": {
        "ref": "ピリピ人への手紙 1:6",
        "text": "あなたがたのうちに良い働きを始められた方は、キリスト・イエスの日までにそれを完成させてくださると、私は確信しています。"
      }
    },
    {
      "id": "2",
      ...
      "summary": "パウロの投獄がかえって福音の前進に役立ちました。「生きることはキリスト、死ぬことも益です。」生きても死んでもキリストがあがめられます。",
    ...
    },
    {
      ...
      "summary": "キリストは神の御姿であられたのに、ご自分を無にして仕える者の姿をとり、十字架の死にまで従われました。それゆえ神は高く引き上げられました。",
      ...
      "memoryVerse": {
        "ref": "ピリピ人への手紙 2:9–11",
        "text": "それゆえ神は、キリストを高く引き上げ、すべての名にまさる名をお与えになりました。それは、イエスの御名によって、天にあるもの、地にあるもの、地の下にあるもののすべてがひざをかがめ、すべての舌が「イエス・キリストは主です」と告白して、父なる神に栄光を帰するためです。"
      }
    },
    {
      "id": "4",
      ...
      "summary": "恐れおののいて救いを達成しなさい。心に働いてみこころを行わせるのは神です。テモテやエパフロディトの忠実な模範が語られます。",
    ...
    },
    {
      ...
      "summary": "以前は誇りとしていたすべてをキリストのゆえにちりと見なすパウロ。後ろのものを忘れ、目標に向かってひたすら走ります。",
      ...
      "memoryVerse": {
        "ref": "ピリピ人への手紙 3:9",
        "text": "律法による自分の義ではなく、キリストを信じることによる義、すなわち信仰に基づいて神から与えられる義を持つ者となって、キリストのうちに見いだされるためです。"
      }
    },
    {
      "id": "6",
      ...
      "summary": "何も思い煩わず感謝をもって祈りなさい。人知を超える神の平安が守ります。どんな境遇にも処する秘訣を学んだパウロは「私を強くしてくださる方によって何でもできる」と告白します。",
