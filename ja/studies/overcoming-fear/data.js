...
window.STUDY = {
  ...
  "sessionsLabel": "12回",
  "stepTimes": {
    "lookback": "20&ndash;30 min",
    "lookup": "20&ndash;30 min",
    "lookforward": "20&ndash;30 min"
  },
  "defaultReadNote": "the passage aloud, then look for the promise verse within it.",
  "lookForwardTemplate": "（いつまでに）私は（具体的な行動）を行います。それにより（目的／実生活への適用）となるためです。",
  "welcomeCopy": {
    "tagline": "嵐の中の平安",
    "titleHtml": "恐れを乗り越える",
    "lead": "旧約の紅海から新約の黙示録まで、聖書全体をたどる12回。私たちの深い恐れの中に、神がどのように平安と勝利の勇気を与えてくださるかを発見します。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "圧倒的な勝利",
    "body": "12の聖書箇所を通して、あらゆる恐れの中にある神の真実と臨在を体験しました。愛には恐れがありません。主が世に勝利されたからです。",
    "leadSomeoneElse": "あなた自身がすでに次の人を導く準備ができています。準備ができたら誰かを誘って再スタートしましょう。",
    "nextStudy": "『新しいいのち、本当の喜び（ピリピ人への手紙）』や『私たちに祈りを教えてください』に進むのがおすすめです。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "summary": "前に紅海、後ろにエジプト軍という絶体絶命の危機。モーセは民に語ります。「恐れてはならない。しっかり立って、今日あなた方のために行われる主の救いを見なさい。」主は海を分け、乾いた地を渡らせられました。",
      "lookBack": {
        "note": "まだ「前回」はないので、まずはここから始めましょう。",
        "questions": [
          "お名前と、このグループのメンバーがまだ知らないようなあなたについてのことを1つ教えてください。",
          "大きなことでも小さなことでも、あなたが心から恐れていることは何ですか？",
      ...
      "promiseVerse": {
        "ref": "Exodus 14:13",
        "text": "Moses answered the people, &ldquo;Do not be afraid. Stand firm, and you will see the deliverance the LORD will bring you today.&rdquo;"
      },
      "memoryVerse": {
        "ref": "出エジプト記 14:13",
        "text": "モーセは民に言った。「恐れてはならない。しっかり立って、今日あなた方のために行われる主の救いを見なさい。」"
      }
    },
    {
      "id": "2",
      ...
      "summary": "巨人ゴリヤテがイスラエルの神を侮辱し、全軍が恐れおののきます。少年ダビデは万軍の主の御名によって立ち向かい、石投げで巨人を打ち倒します。戦いは主のものです。",
      ...
      "promiseVerse": {
        "ref": "1 Samuel 17:45",
        "text": "David said to the Philistine, &ldquo;You come against me with sword and spear and javelin, but I come against you in the name of the LORD Almighty, the God of the armies of Israel, whom you have defied.&rdquo;"
      },
      "memoryVerse": {
        "ref": "サムエル記第一 17:45",
        "text": "ダビデはペリシテ人に言った。「おまえは剣と槍と投げ槍を持って私に向かって来るが、私は万軍の主の御名によっておまえに立ち向かう。」"
      }
    },
    {
      "id": "3",
      ...
      "summary": "「主は私の羊飼い。私には乏しいことがありません。」死の陰の谷を歩むときも、災いを恐れません。主が共におられ、主のむちと杖が慰めてくださるからです。",
      ...
      "memoryVerse": {
        "ref": "詩篇 23:6",
        "text": "まことに私のいのちの日の限り、いつくしみと恵みが私を追って来るでしょう。私はいつまでも主の家に住まいます。"
      }
    },
    {
      "id": "4",
      ...
      "summary": "いと高き方の隠れ場に住む者は、全能者の陰に宿ります。主は私の避け所、私の砦。主が御使いたちに命じて、歩むすべての道であなたを守られます。",
      ...
      "promiseVerse": {
        "ref": "Psalm 91:10&ndash;11",
        "text": "no harm will overtake you, no disaster will come near your tent. For he will command his angels concerning you to guard you in all your ways."
      },
      "memoryVerse": {
        "ref": "詩篇 91:10–11",
        "text": "わざわいはあなたに降りかからず、疫病もあなたの天幕に近づかない。主があなたのために御使いたちに命じて、あなたのすべての道であなたを守られるからだ。"
      }
    },
    {
      "id": "5",
      ...
      "summary": "何を食べようか、何を着ようかと思い煩ってはなりません。空の鳥や野の百合を養われる天の父がおられます。まず神の国と神の義を求めなさい。",
    ...
    },
    {
      ...
      "summary": "ガリラヤ湖の猛烈な嵐に舟は水をかぶり、イエスは艫で眠っておられます。「先生、私たちが溺れても構わないのですか。」イエスは風と波を叱りつけ、深い静けさが訪れます。",
      ...
      "promiseVerse": {
        "ref": "Mark 4:39&ndash;40",
        "text": "He got up, rebuked the wind and said to the waves, &ldquo;Quiet! Be still!&rdquo; Then the wind died down and it was completely calm. He said to his disciples, &ldquo;Why are you so afraid? Do you still have no faith?&rdquo;"
      },
      "memoryVerse": {
        "ref": "マルコの福音書 4:39–40",
        "text": "イエスは起き上がって風を叱り、湖に「静まれ、黙れ」と言われた。すると風はやみ、大凪になった。イエスは彼らに言われた。「なぜ怖がるのか。まだ信仰がないのか。」"
      }
    },
    {
      "id": "7",
      ...
      "summary": "暗夜に逆風と戦う弟子たちのもとへ、イエスが湖の上を歩いて来られます。「幽霊だ」と叫ぶ彼らに、イエスは「安心しなさい。わたしだ。恐れることはない」と声をかけられます。",
      ...
      "promiseVerse": {
        "ref": "Mark 6:50",
        "text": "because they all saw him and were terrified. Immediately he spoke to them and said, &ldquo;Take courage! It is I. Don&rsquo;t be afraid.&rdquo;"
      },
      "memoryVerse": {
        "ref": "マルコの福音書 6:50",
        "text": "彼らはみなイエスを見て怯えていたのである。しかし、イエスはすぐに彼らに話しかけ、「しっかりしなさい。わたしだ。恐れることはない」と言われた。"
      }
    },
    {
      "id": "8",
      ...
      "summary": "敵を恐れて鍵をかけた部屋に、復活のイエスが現れ、「平安があなたがたにあるように」と語りかけられます。恐れは礼拝と使命へと変わります。",
      ...
      "promiseVerse": {
        "ref": "John 20:19",
        "text": "On the evening of that first day of the week, when the disciples were together, with the doors locked for fear of the Jewish leaders, Jesus came and stood among them and said, &ldquo;Peace be with you!&rdquo;"
      },
      "memoryVerse": {
        "ref": "ヨハネの福音書 20:19",
        "text": "その日、すなわち週の初めの日の夕方のことであった。弟子たちがいた所では、ユダヤ人を恐れて戸に鍵がかけられていた。するとイエスが来て彼らの真ん中に立ち、「平安があなたがたにあるように」と言われた。"
      }
    },
    {
      "id": "9",
      ...
      "summary": "「誰がキリストの愛から私たちを引き離すことができましょう。」患難も、苦難も、迫害も、私たちを愛してくださる方によって圧倒的な勝利者となります。",
      ...
      "memoryVerse": {
        "ref": "ローマ人への手紙 8:38–39",
        "text": "私はこう確信しています。死も、いのちも、御使いも、支配者も、今あるものも、後に来るものも、力あるものも、高いところにあるものも、深いところにあるものも、そのほかのどんな被造物も、私たちの主キリスト・イエスにある神の愛から、私たちを引き離すことはできません。"
      }
    },
    {
      "id": "10",
      ...
      "summary": "何も思い煩わないで、あらゆる場合に祈りと願いをもって、感謝を添えて求めを神に告げなさい。人知を超える神の平安が心と思いとを守ります。",
    ...
    },
    {
      ...
      "summary": "信仰とは望んでいる事柄の確信であり、見えない事実の証拠です。信仰がなければ神に喜ばれることはできません。恐れを乗り越える力は信仰です。",
      ...
      "memoryVerse": {
        "ref": "ヘブル人への手紙 11:6",
        "text": "信仰がなければ、神に喜ばれることはできません。神に近づく者は、神がおられることと、神を求める者には報いてくださる方であることを信じなければならないのです。"
      }
    },
    {
      "id": "12",
      ...
      "summary": "新しい天と地。もはや死もなく、悲しみも叫びも痛みもありません。神と小羊の御座があり、すべての涙がぬぐい去られ、恐れは永遠に消え去ります。",
      ...
      "promiseVerse": {
        "ref": "Revelation 22:3",
        "text": "No longer will there be any curse. The throne of God and of the Lamb will be in the city, and his servants will serve him."
      },
      "memoryVerse": {
        "ref": "ヨハネの黙示録 22:3",
        "text": "もはや、のろわれるものは何もない。神と小羊の御座が都の中にあり、神のしもべたちは神に仕え、"
      }
    }
  ]
};
