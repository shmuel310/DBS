...
window.STUDY = {
  ...
  "sessionsLabel": "8週間",
  "welcomeCopy": {
    "tagline": "マタイ5〜7章に示された神の国の憲章",
    "titleHtml": "山上の垂訓",
    "lead": "イエスが山上で語られた最も深く有名な神の国の教え。八福、塩と光、律法を超える義、隠れたところでの信仰、そして岩の上に建てる信仰を8週間で学びます。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "岩の上に建てられた信仰",
    "body": "8週間の山上の垂訓を通して、みことばを聞いて行う者へと形作られました。キリストという岩の上に建てられた人生は、決して揺らぐことがありません。",
    "leadSomeoneElse": "あなた自身がすでに次の人を導く準備ができています。準備ができたら誰かを誘って再スタートしましょう。",
    "nextStudy": "『この方は誰なのか？』や『つながり、勝ち取り、育て、整え、遣わす』に進むのがおすすめです。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 5:8",
        "text": "「心の清い者は幸いです。その人たちは神を見るからです。」"
      }
    },
    {
      "id": "2",
      ...
      "summary": "あなたがたは地の塩、世の光です。光を輝かせ天の父をあがめさせなさい。イエスは律法を廃棄するためではなく、成就するために来られました。",
    ...
    },
    {
      ...
      "summary": "怒り、情欲、誓い、そして敵を愛すること。字面を超えて心の深みに迫るイエスの教え。「天の父が完全であられるように、あなたがたも完全でありなさい。」",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 5:44",
        "text": "「しかし、わたしはあなたがたに言います。自分の敵を愛し、自分を迫害する者のために祈りなさい。」"
      }
    },
    {
      "id": "4",
      ...
      "summary": "人に見せるために善行を行ってはならない。施し、祈り、断食は隠れたところで行いなさい。隠れた所を見ておられる父が報いてくださいます。主の祈りです。",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 6:9–10",
        "text": "「ですから、あなたがたはこう祈りなさい。『天におられる私たちの父よ、御名があがめられますように。御国が来ますように。みこころが天で行われるように、地でも行われますように。』」"
      }
    },
    {
      "id": "5",
      ...
      "summary": "地上に宝を積んではならない。天に宝を積み上げなさい。心は宝のある所にあります。何を食べようかと憂えず、まず神の国と神の義を求めなさい。",
    ...
    },
    {
      ...
      "summary": "さばいてはならない。自分の目から梁を取り除きなさい。求めよ、そうすれば与えられる。人にしてもらいたいことを人にもしなさい（黄金律）。",
    ...
    },
    {
      ...
      "summary": "狭い門から入りなさい。滅びに至る門は大きく道は広く、いのちに至る門は狭く道は細い。偽預言者を警戒し、その実によって見分けなさい。",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 7:14",
        "text": "「いのちに至る門は小さく、その道は狭く、それを見出す者はわずかです。」"
      }
    },
    {
      "id": "8",
      ...
      "summary": "みことばを聞いて行う者は、岩の上に家を建てた賢い人のようです。雨が降り洪水が押し寄せても倒れません。群衆はその権威ある教えに驚嘆しました。",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 7:24",
        "text": "「ですから、わたしのこれらのことばを聞いて、それを行う者はみな、岩の上に自分の家を建てた賢い人に比べることができます。」"
      }
    }
  ]
};
