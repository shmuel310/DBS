...
window.STUDY = {
  ...
  "sessionsLabel": "10週間",
  "welcomeCopy": {
    "tagline": "マルコの福音書をたどる旅",
    "titleHtml": "この方は<br>誰な<br>のか？",
    "lead": "マルコの福音書とともに歩む10週間。毎週少しずつ聖書を読み、イエスがどのような方であるかを発見し、グループまたは1対1でともに主に従いましょう。"
  },
  "methodCopy": {
    "lead": "毎週、同じ順序で同じ <strong style=\"color:var(--ink-900);font-weight:600;\">3つのステップ</strong> を踏みます。2人でも小グループでも同様です。所要時間の目安は全体で <strong style=\"color:var(--ink-900);font-weight:600;\">60〜90分</strong> ですが、あくまで大まかな目安です。",
    "lookBackBlurb": "聖書を開く前に、短く率直に近況を分かち合います。先週はどう過ごしたか、何を実践してみたか、互いにどのように祈り合えるかを話します。",
    "lookUpBlurb": "祈り、聖書箇所を声に出して読み、自分の言葉で言い直して、話の全容を把握したか確かめます。その上で5つの質問を通して深く掘り下げます。",
    "lookForwardBlurb": "発見したことを実際の生活への応答へと変えます。実践すべき行動、信頼すべき約束、見習うべき模範、従うべき命令などです。今週誰にこの聖書箇所を伝えるかを決め、最後に互いのために祈ります。その相手への伝達が来週の「振り返る」の話題になります。",
    "betweenBlurb": "多くの週には、個人で読むための任意の通読箇所も用意されており、グループで飛ばしたマルコの物語を補うことができます。誰もチェックしませんので、次のセッションまでに物語の全体像をつかみたい人のために役立ててください。"
  },
  "finishCopy": {
    "heading": "よくやり遂げました",
    "body": "10週間、10の聖書箇所、そして全体を貫く1つの問い——「この方は誰なのか？」。振り返り、見上げ、前を向くリズムをずっと共にしてきました。それは決して小さなことではなく、本当の終わりでもありません。",
    "leadSomeoneElse": "このコースは特別な訓練を受けなくても進められるよう作られており、あなた自身がすでに他の人を導く準備ができています。10週間にわたって各聖書箇所を誰かに伝えてきたなら、その人が最初の招待相手としてぴったりです。準備ができたら進捗をリセットし、その人と一緒に再スタートしましょう。",
    "nextStudy": "知らず知らずのうちに、あなた方はディスカバリー・バイブル・スタディ（DBS）を実践してきました。これは誰かと一緒に聖書を読むためのシンプルで再現可能な方法です（振り返る、見上げる、前を向く）。あらゆる聖書箇所や書巻でこのリズムを続けてみてください。『キリスト者の基礎』や『新しいいのち、本当の喜び（ピリピ人への手紙）』は、次に進むコースとして最適です。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "summary": "イエスはバプテスマを受け、荒野で試みを受け、神の国が近づいたと宣べ伝え始められます。ごく普通の漁師たちを最初の弟子として招かれ、彼らはすぐすべてを捨ててイエスに従いました。",
      "noBibleNote": "まだ聖書をお持ちでないですか？今週は無料のYouVersionアプリをご利用ください。あなた専用の聖書もご用意します。",
      "lookBack": {
        "note": "まだ「先週」はないので、まずはここから始めましょう。",
        "questions": [
          "お名前と、このグループのメンバーがまだ知らないようなあなたについてのことを1つ教えてください。",
          "何をきっかけにイエスに従い始めましたか？または、もっと知りたいと思うようになりましたか？",
          "これから10週間の歩みを共にする中で、どのようなことを期待していますか？",
          "今週、感謝していることは何ですか？",
          "このコースを始めるにあたり、あなたのためにどのように祈ることができますか？"
        ]
      },
      "lookUpPrayer": "声に出して祈ったことがなくても大丈夫です。一言だけで十分です。先ほど出た感謝なことを1つ神に感謝し、聖書を読む中でイエスの姿がはっきりと見えるよう聖霊に助けを求めましょう。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 1:17",
        "text": "「わたしについて来なさい。人間をとる漁師にしてあげよう。」"
      }
    },
    {
      "id": "2",
      "title": "罪を赦すことができるのは誰か",
      "refs": [
        "マルコの福音書 2:1–12"
      ],
      "summary": "4人の友人が屋根をはがし、イエスの前に中風の男をつり降ろします。イエスは足の癒やしより先に彼の罪を赦されました。これは神にしかできない宣言です。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 2:10",
        "text": "「しかし、人の子が地上で罪を赦す権威を持っていることを、あなたがたに知らせるために。」"
      }
    },
    {
      "id": "3",
      ...
      "summary": "ガリラヤ湖での突然の嵐が、経験豊かな漁師たちを恐怖に陥れます。イエスが一言で嵐を静められたとき、弟子たちはこのコースの名前の由来となった問いを発します。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 4:41",
        "text": "彼らは非常に恐れて、互いに言った。「いったいこの方は誰なのだろう。風や波までが従うとは。」"
      }
    },
    {
      "id": "4",
      ...
      "summary": "途方に暮れた父親と、12年間病気に苦しむ絶望的な女性。二人は群衆をかき分けてイエスのもとに歩み寄り、想像をはるかに超えたイエスの憐れみに出会います。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 5:34",
        "text": "イエスは彼女に言われた。「娘よ、あなたの信仰があなたを救いました。安心して行きなさい。病気にかからず、健やかでいなさい。」"
      }
    },
    {
      "id": "5",
      ...
      "summary": "人里離れた場所で空腹を抱える5千人。弟子たちは群衆を解散させようとしますが、イエスはわずか5つのパンと2匹の魚を祝福し、弟子たちに配らせ、全員を満腹にされます。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 6:34",
        "text": "イエスは舟から降り、大勢の群衆をご覧になって、彼らを深く憐れまれた。彼らが羊飼いのいない羊のようであったからである。そして彼らに多くのことを教え始められた。"
      }
    },
    {
      "id": "6",
      ...
      "summary": "ピリポ・カイザリヤへの道中で、イエスは弟子たちに尋ねられます。「あなたがたはわたしを誰だと言うか。」ペテロは正しく答えますが、イエスは自らの死を予告し、従うことの真の代価を示されます。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 8:29",
        "text": "イエスは彼らにお尋ねになった。「あなたがたは、わたしを誰だと言いますか。」ペテロが答えて言った。「あなたはキリストです。」"
      }
    },
    {
      "id": "7",
      "title": "仕えられるためではなく、仕えるために",
      "refs": [
        "マルコの福音書 10:32–45"
      ],
      "summary": "イエスがエルサレムで死に向かって歩まれる中、ヤコブとヨハネは最高の座を求めます。イエスはご自身の生涯によって真の偉大さを定義されます。仕えられるためではなく、仕えることです。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 10:45",
        "text": "「人の子も、仕えられるためではなく仕えるために、また多くの人のための贖いの代価として、自分のいのちを与えるために来たのです。」"
      }
    },
    {
      "id": "8",
      ...
      "summary": "ある律法学者が、すべての掟の中で何が一番大切かを尋ねます。イエスの答えはすべての宗教的な決まりを2つの愛に要約しました。神を心から愛すること、そして隣人を自分のように愛することです。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 12:30",
        "text": "「『心を尽くし、いのちを尽くし、知性を尽くし、力を尽くして、あなたの神である主を愛しなさい。』」"
      }
    },
    {
      "id": "9",
      ...
      "summary": "最後の晩餐で制定されたパンと杯、そしてそれに続くゲツセマネの園での祈り。弟子たちが眠りこける中、イエスはおひとりで父のみこころに従われます。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 14:36",
        "text": "そしてこう言われた。「アバ、父よ。あなたには、すべてのことができます。どうか、この杯をわたしから過ぎ去らせてください。しかし、わたしの願うことではなく、みこころのままになさってください。」"
      }
    },
    {
      "id": "10",
      ...
      "refDisplay": "Mark 15:21&ndash;47; 16:1&ndash;8",
      "summary": "十字架、息を引き取られた瞬間、埋葬、そして早朝の空の墓。マルコの福音書は、驚きと畏怖、そしてまだ完結していない物語とともに幕を閉じます。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 16:6",
        "text": "青年は言った。「驚くことはありません。あなたがたは、十字架につけられたナザレ人イエスを捜しているのでしょう。あの方はよみがえられました。ここにはおられません。ご覧なさい。ここがあの方の納められた場所です。」"
      }
    }
  ],
  "bonusSessions": [
    {
      ...
      "bonus": true,
      "fitsAfter": "第2週（罪を赦すことができるのは誰か）の後に適しています",
      "summary": "イエスは山に登り、ご自分が望む者たちを呼び寄せ、みそばに置き、宣教に遣わすために十二人を任命されました。",
    ...
    },
    {
      ...
      "bonus": true,
      "fitsAfter": "第3週（この方は誰なのか？）の後に適しています",
      "summary": "湖のほとりで種蒔きのたとえを教えられます。道端、岩地、茨の中、そして百倍の実を結ぶ良い地です。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 4:20",
        "text": "「また、良い地に蒔かれたものとは、みことばを聞いて受け入れ、三十倍、六十倍、百倍の実を結ぶ人たちのことです。」"
      }
    },
    {
      "id": "B3",
      ...
      "bonus": true,
      "fitsAfter": "第3週（この方は誰なのか？）の後に適しています",
      "summary": "レギオンという悪霊に憑かれた人が解放されます。イエスは彼に、家に帰り主がしてくださった大きなことを知らせるよう命じられます。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 5:19",
        "text": "イエスは許さないで、彼に言われた。「あなたの家、あなたの家族のところに帰り、主があなたにどれほど大きなことをしてくださったか、また、あわれんでくださったかを知らせなさい。」"
      }
    },
    {
      "id": "B4",
      ...
      "bonus": true,
      "fitsAfter": "第6週（わたしを誰だと言うか）の後に適しています",
      "summary": "イエスに従うための条件：自分を捨て、自分の十字架を負って従うこと。人は全世界を手に入れても命を失ったら何の益もないと説かれます。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 8:36",
        "text": "「人は、たとえ全世界を手に入れても、自分のいのちを失ったら、何の益があるでしょうか。」"
      }
    },
    {
      "id": "B5",
      ...
      "bonus": true,
      "fitsAfter": "第6週（わたしを誰だと言うか）の後に適しています",
      "summary": "山の上での変貌。イエスの姿が光り輝き、モーセとエリヤが現れ、雲から「これはわたしの愛する子、彼に聞け」と声が響きます。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 9:7",
        "text": "すると雲がわき起こって彼らをおおい、雲の中から声がした。「これはわたしの愛する子。彼の言うことを聞きなさい。」"
      }
    },
    {
      "id": "B6",
      ...
      "bonus": true,
      "fitsAfter": "第7週（仕えるために）の後に適しています",
      "summary": "盲人のバルテマイがダビデの子イエスに叫びます。「何をしてほしいのか」と問われ、目が見えるようになってイエスに従いました。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 10:52",
        "text": "イエスは彼に言われた。「行きなさい。あなたの信仰があなたを救いました。」すると、彼はすぐに目が見えるようになり、道を進むイエスに従った。"
      }
    },
    {
      "id": "B7",
      ...
      "refDisplay": "Mark 11:1&ndash;11, 15&ndash;19",
      "bonus": true,
      "fitsAfter": "第7週（仕えるために）の後に適しています",
      "summary": "子ろばに乗ってエルサレムに入城し、人々はホサナと叫びます。その後宮に入り、商人を追い出して祈りの家としての聖さを回復されます。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 11:9",
        "text": "前を行く者たちも後に従う者たちも叫んだ。「ホサナ。祝福あれ、主の御名によって来られる方に。」"
      }
    },
    {
      "id": "B8",
      ...
      "bonus": true,
      "fitsAfter": "第9週（最後の晩餐）の後に適しています",
      "summary": "大祭司の前で沈黙を守りつつ自らがキリストであることを告白するイエスと、外庭で火にあたりながら三度主を否認し泣き崩れるペテロ。",
      ...
      "memoryVerse": {
        "ref": "マルコの福音書 14:62",
        "text": "イエスは言われた。「わたしはそれです。あなたがたは、人の子が全能者の右の座に着き、天の雲に乗って来るのを見ることになります。」"
      }
    }
  ]
};
