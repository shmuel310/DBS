...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "キリストに従う弟子の歩み",
    "titleHtml": "イエスの命令",
    "lead": "イエスが弟子たちに従うよう命じられた14の掟。単に知るだけでなく、主の教えを日々の生活の中で実践するためのコースです。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "従順といのち",
    "body": "14の命令は、弟子としてキリストに従う明確な道筋を示しています。主を愛する者は、その命令を守ります。",
    "leadSomeoneElse": "あなた自身がすでに次の人を導く準備ができています。準備ができたら誰かを誘って再スタートしましょう。",
    "nextStudy": "『つながり、勝ち取り、育て、整え、遣わす』や『神の国』に進むのがおすすめです。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "summary": "イエスは「時が満ち、神の国が近づいた。悔い改めて福音を信じなさい」と宣教を開始されました。すべての弟子の歩みの出発点です。",
      "lookBack": {
    ...
    },
    {
      ...
      "summary": "「わたしについて来たい者は、自分を捨て、自分の十字架を負って、わたしに従いなさい。」自己中心を明け渡し、キリストに従います。",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 16:24",
        "text": "それからイエスは弟子たちに言われた。「だれでもわたしについて来たいと思うなら、自分を捨て、自分の十字架を負って、わたしに従いなさい。」"
      }
    },
    {
      "id": "3",
      ...
      "summary": "「あらゆる国の人々を弟子としなさい。父、子、聖霊の名においてバプテスマを授けなさい。」キリストへの帰属を公に示す第一歩です。",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 28:19",
        "text": "「ですから、あなたがたは行って、あらゆる国の人々を弟子としなさい。父、子、聖霊の名においてバプテスマを授け、」"
      }
    },
    {
      "id": "4",
      ...
      "summary": "「心を尽くし、いのちを尽くし、知性を尽くしてあなたの神である主を愛しなさい。」そして「隣人を自分のように愛しなさい。」",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 22:37–39",
        "text": "イエスは彼に言われた。「『心を尽くし、いのちを尽くし、知性を尽くして、あなたの神である主を愛しなさい。』これが重要な第一の戒めです。『あなたの隣人を自分自身のように愛しなさい』という第二の戒めも、それと同じように重要です。」"
      }
    },
    {
      "id": "5",
      ...
      "summary": "「互いに愛し合いなさい。わたしがあなたがたを愛したように、互いに愛し合いなさい。これにより弟子であることをすべての人が認めます。」",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 13:34",
        "text": "「わたしは、あなたがたに新しい戒めを与えます。互いに愛し合いなさい。わたしがあなたがたを愛したように、あなたがたも互いに愛し合いなさい。」"
      }
    },
    {
      "id": "6",
      ...
      "summary": "「さばいてはならない。さばかれないためである。」まず自分の目から梁を取り除きなさい。そうすれば兄弟の塵をよく見ることができます。",
    ...
    },
    {
      ...
      "summary": "「何事でも、自分にしてもらいたいことは、ほかの人にもそのようにしなさい。これが律法と預言者です。」",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 7:12",
        "text": "「ですから、人にしてもらいたいと望むことは何でも、あなたがたも同じように人にしなさい。これが律法と預言者です。」"
      }
    },
    {
      "id": "8",
      ...
      "summary": "何を食べようか思い煩ってはなりません。まず神の国と神の義を求めなさい。そうすればこれらはすべて添えて与えられます。",
    ...
    },
    {
      ...
      "summary": "「わたしにとどまりなさい。わたしもあなたがたにとどまります。枝が木にとどまっていなければ実を結べないように、わたしを離れては何もできません。」",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 15:4",
        "text": "「わたしにとどまりなさい。わたしもあなたがたのうちにとどまります。枝がぶどうの木にとどまっていなければ、自分では実を結ぶことができないのと同じように、あなたがたもわたしにとどまっていなければ、実を結ぶことができません。」"
      }
    },
    {
      "id": "10",
      ...
      "refDisplay": "Matthew 6:9; 26:41",
      "summary": "「天におられる私たちの父よ、御名があがめられますように。」誘惑に陥らないよう目を覚まして祈りなさい。霊は燃えていても肉体は弱いのです。",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 6:9",
        "text": "「ですから、あなたがたはこう祈りなさい。『天におられる私たちの父よ、御名があがめられますように。』」"
      }
    },
    {
      "id": "11",
      ...
      "summary": "「主であり師であるわたしがあなたがたの足を洗ったのなら、あなたがたも互いに足を洗い合うべきです。わたしが手本を示しました。」",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 13:14",
        "text": "「主であり師であるわたしが、あなたがたの足を洗ったのなら、あなたがたも互いに足を洗い合うべきです。」"
      }
    },
    {
      "id": "12",
      "title": "あなたがたの光を輝かせなさい",
      "refs": [
        "マタイの福音書 5:16"
      ],
      "summary": "あなたがたの光を人々の前で輝かせなさい。彼らが良い行いを見て、天の父をあがめるようになるためです。",
      ...
      "memoryVerse": {
        "ref": "マタイの福音書 5:16",
        "text": "「このように、あなたがたの光を人々の前で輝かせなさい。人々があなたがたの良い行いを見て、天におられるあなたがたの父をあがめるようになるためです。」"
      }
    },
    {
      "id": "13",
      ...
      "summary": "「これはあなたがたのために与えられる、わたしのからだです。わたしを覚えてこれを行いなさい。」主の死を覚える聖餐の命令です。",
      ...
      "memoryVerse": {
        "ref": "ルカの福音書 22:19",
        "text": "それからパンを取り、感謝の祈りをささげて裂き、彼らに与えて言われた。「これは、あなたがたのために与えられる、わたしのからだです。わたしを覚えて、これを行いなさい。」"
      }
    },
    {
      "id": "14",
      ...
      "summary": "「天上天下のすべての権威がわたしに与えられています。ですから行って、あらゆる国の人々を弟子としなさい。」大宣教命令です。",
