...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "イエスが誰であるかを知るしるし",
    "titleHtml": "ヨハネの福音書のしるし",
    "lead": "ヨハネの福音書に記された8つの奇跡の「しるし」。そのすべてが、イエスがまことのいのちの源であり、世の光、神の子であることを指し示しています。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "確信といのち",
    "body": "8つのしるしは1つの真理を指し示しています。イエスこそ神の子キリストであり、信じる者に永遠のいのちを与えてくださる方です。",
    "leadSomeoneElse": "あなた自身がすでに次の人を導く準備ができています。準備ができたら誰かを誘って再スタートしましょう。",
    "nextStudy": "『この方は誰なのか？』や『恐れを乗り越える』に進むのがおすすめです。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 2:11",
        "text": "イエスはこのことを最初のしるしとしてガリラヤのカナで行い、ご自分の栄光を現された。それで弟子たちはイエスを信じた。"
      }
    },
    {
      "id": "2",
      ...
      "summary": "息子の危篤に苦しむ高官に、イエスは「帰りなさい。あなたの息子は生きます」と言われました。彼は言葉を信じ、一家全員が信じました。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 4:50",
        "text": "イエスは彼に言われた。「帰りなさい。あなたの息子は生きます。」その人はイエスが言われたことばを信じて、帰って行った。"
      }
    },
    {
      "id": "3",
      ...
      "summary": "ベテスダの池で38年間病気だった人を癒やし、「起きて床を担いで歩きなさい」と命じられます。安息日の主としての権威を示されました。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 5:8–9",
        "text": "イエスは彼に言われた。「起きて床を取り上げ、歩きなさい。」すると、その人はすぐに直って、床を取り上げて歩き出した。"
      }
    },
    {
      "id": "4",
      ...
      "summary": "5つのパンと2匹の魚がイエスの感謝の祈りによって増え、5千人を満腹にして12のかごが残りました。イエスはいのちのパンです。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 6:35",
        "text": "イエスは言われた。「わたしがいのちのパンです。わたしのもとに来る者は決して飢えることがなく、わたしを信じる者は決して渇くことがありません。」"
      }
    },
    {
      "id": "5",
      ...
      "summary": "暗闇と逆風の湖上を歩いて舟に近づかれるイエス。「わたしだ、恐れることはない」との声が弟子たちに確信を与えます。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 6:20",
        "text": "イエスは彼らに言われた。「わたしだ。恐れることはない。」"
      }
    },
    {
      "id": "6",
      ...
      "summary": "生まれつき目が見えなかった人の目に泥を塗り、シロアムの池で洗わせます。目が見えるようになった彼はイエスが世の光であることを証しします。",
    ...
    },
    {
      ...
      "summary": "死後4日経ったラザロの墓の前で、「わたしは復活であり、いのちである」と宣言し、大声で呼び出して死者をよみがえらせます。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 11:25–26",
        "text": "イエスは彼女に言われた。「わたしは復活であり、いのちです。わたしを信じる者は、死んでも生きるのです。また、生きていてわたしを信じる者はみな、永遠に決して死にません。あなたはこのことを信じますか。」"
      }
    },
    {
      "id": "8",
      ...
      "summary": "空の墓、そして復活の主との出会い。「わが主、わが神」と告白したトマス。これらのことが書かれたのは、イエスが神の子キリストであると信じるためです。",
      ...
      "memoryVerse": {
        "ref": "ヨハネの福音書 20:31",
        "text": "しかし、これらのことが書かれたのは、イエスが神の子キリストであることを、あなたがたが信じるため、また、信じて、イエスの御名によっていのちを得るためである。"
      }
    }
  ]
};
