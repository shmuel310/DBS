...
window.STUDY = {
  ...
  "welcomeCopy": {
    "tagline": "恵みと贖いの物語",
    "titleHtml": "ルツ記",
    "lead": "喪失、誠実、そして贖いの感動的な物語。士師の時代の暗闇に輝く美しい歴史を5回でたどり、神の恵みがどのように人々の歩みを導かれるかを目撃します。"
  },
  "methodCopy": {
  ...
  "finishCopy": {
    "heading": "贖いの恵み",
    "body": "5回のルツ記の学びを通して、平凡な日常の中に織り込まれた神の偉大な救いの御手を見ました。御翼の下に身を寄せる者を神は決して見捨てられません。",
    "leadSomeoneElse": "あなた自身がすでに次の人を導く準備ができています。準備ができたら誰かを誘って再スタートしましょう。",
    "nextStudy": "『イエスに従うことを学ぶ』や『イエスの命令』に進むのがおすすめです。"
  },
  "sessions": [
    {
      "id": "1",
      ...
      "summary": "ナオミはモアブの地で夫と二人の息子を亡くし、ベツレヘムへの帰還を決意します。嫁のルツは「あなたの民は私の民、あなたの神は私の神」と誓って従います。",
      "lookBack": {
        "note": "まだ「前回」はないので、まずはここから始めましょう。",
        "questions": [
          "お名前と、このグループのメンバーがまだ知らないようなあなたについてのことを1つ教えてください。",
          "見知らぬ場所でゼロからやり直さなければならなかった経験はありますか？それはどのような体験でしたか？",
          "これから5回のセッションを一緒に過ごす中で、どのようなことを期待していますか？",
      ...
      "memoryVerse": {
        "ref": "ルツ記 1:16",
        "text": "ルツは言った。「あなたを見捨て、あなたから離れて帰るよう、私にし向けないでください。あなたの行かれる所へ私は行き、あなたがお泊まりになる所で私は泊まります。あなたの民は私の民、あなたの神は私の神です。」"
      }
    },
    {
      "id": "2",
      ...
      "summary": "義母を養うため、ルツははからずも親戚ボアズの畑で落ち穂を拾います。ボアズは異邦の女ルツを厚遇し、主の翼の下に身を避けた信仰を祝福します。",
      ...
      "memoryVerse": {
        "ref": "ルツ記 2:12",
        "text": "「主があなたの行いに報いてくださるように。イスラエルの神、主の御翼の下に身を避けてやって来たあなたに、豊かな報いが主から与えられるように。」"
      }
    },
    {
      "id": "3",
      ...
      "summary": "ナオミの助言に従い、ルツは夜の脱穀場でボアズの足元に横たわります。ボアズは買い戻しの権利を持つ親族として責任を果たすことを約束します。",
      ...
      "memoryVerse": {
        "ref": "ルツ記 3:9",
        "text": "ボアズが「あなたは誰ですか」と尋ねると、彼女は答えた。「私はあなたの仕え女ルツです。お着物の裾をあなたの仕え女の上に広げてください。あなたは買い戻しの権利を持つ親族ですから。」"
      }
    },
    {
      "id": "4",
      ...
      "summary": "城門で長老たちが見守る中、法的な手続きを経てボアズはナオミの家の権利を買い戻し、ルツを妻として迎えることを正式に宣言します。",
      ...
      "memoryVerse": {
        "ref": "ルツ記 4:10",
        "text": "「私は、マフロンの妻であったモアブの女ルツを買い取って私の妻とします。死んだ者の名をその相続地にとどめ、死んだ者の名がその兄弟たちの間から、またその町の門から消え去らないようにするためです。あなたがたは、今日、その証人です。」"
      }
    },
    {
      "id": "5",
      ...
      "summary": "ルツは男の子オベデを産みます。ナオミの空しさは豊かな喜びに変わり、オベデはエッサイを生み、エッサイはダビデ王を生みます。メシアへとつながる驚くべき系図です。",
      ...
      "memoryVerse": {
        "ref": "ルツ記 4:14–15",
        "text": "女たちはナオミに言った。「主がほめたたえられますように。主は今日、あなたのために買い戻しの権利を持つ親族をお残しになりました。この子の名がイスラエルでたたえられますように。この子はあなたのいのちを元気づけ、あなたの老後を養う者となるでしょう。」"
      }
    }
  ]
};
